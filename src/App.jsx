...
let PAYROLL = [
  { name: "Alexander Christopher", hours: 1738.76, totalCost: 54078.08 },
  ...
  { name: "Brown Willie M", hours: 50.30, totalCost: 1454.92 },
  { name: "Butler Richard", hours: 382.40, totalCost: 11493.27, active: false },
  { name: "Camacho Stephen B", hours: 332.22, totalCost: 9599.64 },
  ...
  { name: "Cowsky Andrew", hours: 930.16, totalCost: 28059.82 },
  { name: "Daniels Gerald W", hours: 1047.22, totalCost: 30654.82 },
  { name: "Davis Anthoni D", hours: 2174.71, totalCost: 76298.15 },
  { name: "Denman Samuel E", hours: 1736.44, totalCost: 57573.68 },
  { name: "Dixon Deon A", hours: 138.80, totalCost: 4114.80 },  // un-frozen Aug 3: paid +$1,069.07 in the Jul 27-Aug 2 week
  { name: "Dotch Brandon C", hours: 540.11, totalCost: 16130.43, active: false },
  { name: "Gray Stephen D", hours: 499.33, totalCost: 15164.23 },
  { name: "Gutierrez Danny", hours: 1604.24, totalCost: 50910.22 },
  { name: "Guzman Jose", hours: 1971.80, totalCost: 71622.07 },
  { name: "Howell Lawrence", hours: 85.33, totalCost: 2373.24, active: false },
  { name: "Ibarra Jose Pablo", hours: 1927.49, totalCost: 69053.61 },
  ...
  { name: "Lewis Steve", hours: 281.19, totalCost: 8131.56 },
  ...
  { name: "McDaniels James", hours: 488.69, totalCost: 14326.12 },
  { name: "McNamara John", hours: 1774.92, totalCost: 59390.74 },
  { name: "Mcclam Michael A", hours: 1262.25, totalCost: 38480.68 },
  ...
  { name: "Ponce Carlos", hours: 1200.35, totalCost: 37170.37 },
  { name: "Restrepo Julian E", hours: 1216.96, totalCost: 38262.46 },
  { name: "Reyes Corey", hours: 957.24, totalCost: 27580.83 },
  { name: "Robinson Animashaun", hours: 1119.52, totalCost: 32749.48 },
  { name: "Ronkov Martin P", hours: 1738.45, totalCost: 50386.44 },
  { name: "Secrest Jermelle", hours: 613.67, totalCost: 17708.58, active: false },
  { name: "Stevenson Timothy", hours: 495.00, totalCost: 14288.08 },
  ...
  { name: "Whipple Wallace", hours: 1866.29, totalCost: 60391.84 },
  { name: "Williams Tadaryl C", hours: 1727.29, totalCost: 51314.73 },
  { name: "Williams Will", hours: 1393.12, totalCost: 41620.68 },
  { name: "Willis Wali A", hours: 2033.44, totalCost: 70804.35 },
...
let FUEL = {
  // EFS only, Jan 1 - Aug 2, 2026 - fleet $637,655.89 (116,437.37 gal).
  // EFS report total $771,909.82 / 142,860.06 gal minus the 9 ATL cards $134,253.93 / 26,422.69 gal.
  // Fuel = ULSD + BDSL + CDSL + UNPR + UNRG (all fuel products; excludes DEF, fees, parking, CADV)
  // Excluded from per-driver mapping (still counted in FUEL_TOT): card 17408 ($7,214.09), card 17468 ($6,366.04), card 07409 ($5,223.62), card 67402 ($1,386.71), card 27453 ($971.53), card 47465 ($369.67), card 37452 ($226.71), card 27467 ($90.01)
  // Rows below sum to $622,437.23 vs FUEL_TOT $637,655.89 (gap $15,218.66).
  // Gap != the $21,848.38 unmapped-card total because frozen drivers
  // carry fixed historical fuel values rather than re-deriving from their cards.
  "Alexander Christopher": { fuel: 35347.21, gallons: 5959.97 },  // card 77409
  ...
  "Cowsky Andy": { fuel: 24397.92, gallons: 4120.85 },  // card 77457
  "Daniels Gerald W": { fuel: 16448.49, gallons: 2892.27 },  // card 47402 split (active, absorbs deltas over Christian)
  "Davis Anthoni D": { fuel: 52699.97, gallons: 9602.64 },  // card 27406
  "Denman Samuel E": { fuel: 31660.03, gallons: 6241.63 },  // cards 47405 + 37403
  "Dotch Brandon C": { fuel: 12032.86, gallons: 1880.68 },  // cards 07405 (Anderson-frozen split) + 17468 (UNCHANGED WoW × 3)
  "Gray Stephen D": { fuel: 8841.78, gallons: 1709.09 },  // NEW · card 27403
  ...
  "McNamara John": { fuel: 23971.51, gallons: 5007.39 },  // card 17407
  "Mcclam Michael A": { fuel: 29222.6, gallons: 4470.27 },  // card 07407
  ...
  "Restrepo Julian E": { fuel: 28178.21, gallons: 4945.33 },  // card 37405 split (active, absorbs deltas over Wright+Clark)
  "Reyes Corey": { fuel: 16161.18, gallons: 2445.39 },  // cards 07469 + 97453
  "Robinson Animashaun": { fuel: 10495.34, gallons: 1889.45 },  // card 97455 ("Shaun R" on EFS = Animashaun/Robinson) — was unmapped, he had 968 hrs but $0 fuel
  ...
  "Stevenson Timothy": { fuel: 10868.09, gallons: 1928.14 },  // NEW · card 07452
  ...
  "Whipple Wallace": { fuel: 32992.11, gallons: 6604.43 },  // card 57403
...
let LABOR     = 1285399.59; // QuickBooks: SF FLEET driver payroll (gross+taxes+401k) thru Aug 2. 28 drivers active (frozen + terminated keep YTD so LABOR reconciles; this digit MUST equal ACTIVE_DRIVERS_COUNT — extract-metrics.js publishes it as metrics.json drivers:N. It read 53 through Aug 3 2026 while the UI showed 27; corrected here after verifying 25 of 27 active-flagged drivers were paid this week and Dixon Deon A's stale active:false was cleared). EXCLUDES all 9 ATL drivers (Baker/Dawson/Pacitti/Griffin*/Johnson/Logan/Phillips/Tucker/Wainwright — *Griffin terminated, YTD retained) $167,927.70 / 4,827.29 hrs → ATL_WEEKLY_LOG + ATL CPM, NOT fleet. + Wilson Antionette (ATL office → OFFICE_W2). Reconciles to PAYROLL[] sum per scripts/gen_weekly_arrays.py.
let FUEL_TOT  = 637655.89;  // EFS fleet only — EFS report total $771,909.82 minus the 9 ATL cards (27450/17451/87455/37459/57457/47458/67463/07454/87457) $134,253.93; ATL carved out of fleet CPM
let GALLONS   = 116437.37;  // EFS 142,860.06 minus ATL 26,422.69
let MILES_EST = GALLONS * 6.5;  // kept for fuel avg price calc
let MILES     = 849772.9;     // Samsara Vehicle Mileage (Jan 1 – Aug 1, 2026 — export runs 1 day short of PERIOD end): fleet total 965,151.7 minus the 7 ATL trucks (685/674/669/686/673/675/488) 115,378.8. Regenerate via scripts/parse_samsara_mileage.py (accepts .csv or .xlsx).
...
let TOTAL_HRS  = 40842.71;  // Payroll hours — fleet drivers only (office + 9 ATL drivers + Wilson excluded), thru Aug 2 (matches LABOR's basis)
let INS_WEEK  = 6375;
let INS_TOT    = 201535.58;  // QB: SF Truck Insurance only (CPM insurance = truck insurance) thru Aug 2. UNCHANGED WoW — verified real, not a missing file: July's $52,936.42 all posted by Jul 26.
let TRUCK_TOT  = 585955.24;  // QuickBooks: Truck Rentals (Penske + TEC/Transco + TCI + Ryder) thru Aug 2. +$56,141 WoW = July month-end close landing late, not a spike (July $96,043.62 < June $125,945.25).
let TRAILER_TOT = 257875.28; // QuickBooks: Trailer Rentals (McKinney + Xtra + Utility + Premier + Boxwheel + Ten) thru Aug 2
let EQUIP_TOT   = TRUCK_TOT + TRAILER_TOT;
let TRUCK_MAINT  = 10094.44;  // Prime Wash, AutoForce, Titan Glass, Towing, Batteries, TZ Parts, eBay, SF Heavy Equipment thru Aug 2. UNCHANGED WoW — verified real (July $2,310.99 posted by Jul 26).
let TRAIL_MAINT  = 8100.57;   // TravelCenters of America, MKD Express thru Aug 2
let STORAGE      = 67122.74;  // Storage/Parking per P&L thru Aug 2. +$9,120 WoW = July close (July $21,837.34 is the year's highest month).
let MAINT_TOT    = TRUCK_MAINT + TRAIL_MAINT + STORAGE;
let UNIFORMS     = 12558.68;  // Unifirst + Safety Guard Shoe thru Aug 2. UNCHANGED WoW — verified real (July $3,492.96 posted by Jul 26).
// ── ATL operation (carved out of fleet CPM) — its own CPM tab ───
let ATL_LABOR   = 167927.70;  // 9 ATL drivers YTD (gross+taxes+401k) thru Aug 2
let ATL_HRS     = 4827.29;    // 9 ATL drivers YTD hours thru Aug 2 (matches ATL_LABOR's basis)
let ATL_FUEL    = 134253.93;  // 9 ATL EFS cards YTD thru Aug 2
let ATL_GALLONS = 26422.69;
let ATL_MILES   = 115378.8;   // Samsara: trucks 685/674/669/686/673/675/488, thru Aug 1
...
// ── INCOME DATA ───────────────────────────────────────────────
const INCOME_2026 = {
  period: "Jan 1 – Aug 2, 2026",
  ce: 10273556.21, sf: 4031400.25, di: 83877.20, ceEast: 541724.33,
  total: 14930557.99,
  cogs: 7842349.00, grossProfit: 7088208.99,
  totalExp: 6013250.02, netOpIncome: 1074958.97,
  netIncome: 602153.16,
  carrierPay: 7614794.19, merchantFees: 55079.60, flexentFees: 172475.21,
  weeks: [
  ...
  months: [
    ...
    { m: "Jul", rev: 2212835.07, gp: 1058654.05, ce:1457621.92, sf:662668.54, di:20648.70, carrier:1115354.60, exp:1160779.10, netInc:-196349.45 },  // full July — LOSS month (June was +196,727.70)
  ],
};
...
const OFFICE_W2 = [
  ...
  { name:"Adrian Arias",        entity:"SF",  gross: 51477.66, taxes: 5275.74, contrib: 2051.1, totalCost: 58804.5, salary: 49655.0,    bonus:1622.66, reimb:200.00,    commission:0.00,       note:"Salary + bonus" },
  { name:"Gabriel Gonzalez",    entity:"SF",  gross: 35284.83, taxes: 3796.53, contrib: 0.0,       totalCost: 39081.36, salary: 35003.83, bonus:250.00,     reimb:31.00,     commission:0.00,       note:"Salary + bonus" },
  ...
  { name:"Cecilia Rivera",      entity:"SF",  gross: 41210.0,    taxes: 4426.07, contrib: 1646.6, totalCost: 47282.67, salary: 39625.0,    bonus:1540.00,     reimb:45.00,     commission:0.00,       note:"Salary + bonus" },
  { name:"Nathan Youngblood",   entity:"SF",  gross: 36100.0,    taxes: 3886.65, contrib: 0.0,       totalCost: 39986.65, salary: 36100.0,    bonus:0.00,       reimb:0.00,      commission:0.00,       note:"Salary" },
  { name:"Tasha Mahan",         entity:"SF",  gross: 11700.0,     taxes: 1288.05,  contrib: 0.0,       totalCost: 12988.05,  salary: 11700.0,     bonus:0.00,       reimb:0.00,      commission:0.00,       note:"NEW · started Jun 2026 · office/warehouse" },
  { name:"Antionette Wilson",   entity:"SF",  gross: 7006.0,     taxes: 788.14,  contrib: 0.0,       totalCost: 7794.14,  salary: 7006.0,     bonus:0.00,       reimb:0.00,      commission:0.00,       note:"ATL office support (reclassified from driver Jul 2026)" },
  // J&A Management employees (thru ~Jul 2, 2026 YTD)
  { name:"Valeria Abrego",      entity:"J&A", gross: 24750.1, taxes: 2605.62, contrib: 0.0,       totalCost: 27355.72, salary: 24185.1, bonus:0.00,       reimb:565.00,    commission:0.00,       note:"Hourly + OT" },
  { name:"Christopher Adamson", entity:"J&A", gross: 52000.0,    taxes: 5309.15,    contrib: 2080.0,    totalCost: 59389.15,    salary: 52000.0,    bonus:0.00,       reimb:0.00,      commission:0.00,       note:"Salary + 401K" },
  ...
  { name:"Harold Galvis",       entity:"J&A", gross: 10260.0,     taxes: 1120.03,  contrib: 0.0,       totalCost: 11380.03,  salary: 10260.0,     bonus:0.00,       reimb:0.00,      commission:0.00,       note:"NEW · started Jun 2026" },
  { name:"Kidist Gelaw",        entity:"J&A", gross: 9040.0,     taxes: 1000.25,  contrib: 0.0,       totalCost: 10040.25,  salary: 9040.0,     bonus:0.00,       reimb:0.00,      commission:0.00,       note:"NEW · started Jun 2026" },
  ...
  { name:"Ben Hoffman",         entity:"J&A", gross: 40794.8, taxes: 4322.79, contrib: 376.95,  totalCost: 45494.54, salary: 40584.8, bonus:0.00,       reimb:210.00,     commission:0.00,       note:"Salary + 401K + PTO" },
  { name:"Joshua Law",         entity:"J&A", gross: 12136.93,  taxes: 1265.07,  contrib: 0.0,       totalCost: 13402.0,  salary: 12136.93,  bonus:0.00,       reimb:0.00,      commission:0.00,       note:"NEW · started Jun/Jul 2026" },
...
const WAREHOUSE = [
  { name:"Gentry Eagleton",  entity:"SF", gross: 27034.2, taxes: 2814.64, contrib: 0.0, totalCost: 29848.84, type:"Hourly", hours:1092.16, regHrs:1024.43, otHrs:67.73, note:"Regular + OT" },
  { name:"Andres Figueroa",  entity:"SF", gross: 47112.5, taxes: 4874.87, contrib: 0.0, totalCost: 51987.37, type:"Salary", hours:1080.00,    regHrs:0.00,      otHrs:0.00,     note:"Salary + PTO" },
];

// ATL designation tracked in ATL_WEEKLY_LOG (per-week roster).
// Mellody and ENM no longer tagged here.
const CONTRACTORS = [
  { name:"Jon Marcus Zengotita", dba:"", weekly:2800, payments:27, weeklyTotal:75600, car:350, carPayments:7, carTotal:2450, commission:0, healthIns:0, healthInsTotal:0, other:0, total:78050, note:"$2,800/wk + $350/mo car (6 months · June car now paid)" },
  { name:"Mellody Abrego",       dba:"Neon Vibes Enterprise", weekly:2250, payments:27, weeklyTotal:58950, car:334.86, carPayments:7, carTotal:2694.02, commission:5133.21, healthIns:368.34, healthInsTotal:9945.18, other:0, total:76722.41, note:"$2,250/wk + $334.86/mo car · July car paid (carTotal = 5×334.86 + June 684.86 bump + July 334.86 = 2,694.02) + commission YTD $5,133 (+$300 this wk) + health ins $368.34/wk (26wk)" },
  { name:"Gabriel Colon",        dba:"", weekly:0, payments:26, weeklyTotal:58495.88, car:0, carPayments:0, carTotal:0, commission:0, healthIns:0, healthInsTotal:0, other:0, total:58495.88, note:"Variable weekly — +$2,000 this wk" },
  { name:"Hilda Salman",         dba:"Salman Enterprises LLC", weekly:1730, payments:27, weeklyTotal:46710, car:0, carPayments:0, carTotal:0, commission:0, healthIns:118.82, healthInsTotal:3208.14, other:0, total:49918.14, note:"$1,730/wk + health ins $118.82/wk (26wk)" },
  { name:"Maria Con",            dba:"", weekly:650, payments:26, weeklyTotal:15900, car:0, carPayments:0, carTotal:0, commission:0, healthIns:0, healthInsTotal:0, other:0, total:15900, note:"$550/wk → $650/wk starting Mar 2026" },
  { name:"Logic Consultants",    dba:"Logic Consultants LLC / Prestige Development", weekly:500, payments:26, weeklyTotal:13000, car:0, carPayments:0, carTotal:0, commission:0, healthIns:0, healthInsTotal:0, other:0, total:13000, note:"$500/wk" },
  { name:"ENM Trucking",         dba:"ENM Trucking LLC (Biniyam Fissehaye)", weekly:1850, payments:9, weeklyTotal:16650, car:0, carPayments:0, carTotal:0, commission:0, healthIns:0, healthInsTotal:0, other:0, total:16650, note:"$1,850/wk · W2 (J&A) → 1099 May 11 2026 · ATL contractor (also in ATL_WEEKLY_LOG)" },
  { name:"Elizabeth Delgado",    dba:"", weekly:900, payments:20, weeklyTotal:18000, car:0, carPayments:0, carTotal:0, commission:3597.62, healthIns:0, healthInsTotal:0, other:131.99, total:21729.61, note:"$900/wk base + commission YTD $3,598 (none this wk) + $131.99 reimb (May 18-24) · W2 → 1099 Feb 2026", dual:true },
  { name:"Christopher Simpson",  dba:"", weekly:834.97, payments:20, weeklyTotal:17124.55, car:0, carPayments:0, carTotal:0, commission:2551.20, healthIns:53.79, healthInsTotal:1452.33, other:270, total:21398.08, note:"~$835/wk base + commission YTD $2,551 (none this wk) + health ins $53.79/wk (26wk) · W2 → 1099 Feb 2026", dual:true },
  { name:"Debra Adamson",        dba:"", weekly:1750, payments:20, weeklyTotal:26964.73, car:0, carPayments:0, carTotal:0, commission:0, healthIns:53.79, healthInsTotal:1452.33, other:984.97, total:29402.03, note:"$985/wk (Chase) → $1,750/wk new normal May 2026 + $985 (QuickBooks) + health ins $53.79/wk (26wk) · excl $2K loan", dual:true },
  { name:"Erika Valencio",      dba:"", weekly:1730, payments:4, weeklyTotal:6920, car:0, carPayments:0, carTotal:0, commission:0, healthIns:0, healthInsTotal:0, other:0, total:6920, note:"$1,730/wk · J&A · started week of Jul 6 2026" },
  { name:"Kacy Richardson",     dba:"", weekly:500, payments:3, weeklyTotal:1500, car:0, carPayments:0, carTotal:0, commission:0, healthIns:0, healthInsTotal:0, other:0, total:1500, note:"$500/wk · J&A · started Jul 2026" },
  { name:"Mairena Tapias",      dba:"", weekly:478, payments:13, weeklyTotal:7578.04, car:0, carPayments:0, carTotal:0, commission:0, healthIns:0, healthInsTotal:0, other:0, total:7578.04, note:"Jon Marcus's assistant · 100% CE · paid as expense, wired via Chase. Row covers BOTH assistants: thru 6/30 is Nelly (predecessor), 7/2 forward is Mairena at $478/wk. Label kept merged per Ben." },
];
...
const DRIVER_WEEKLY = {"weeks": ["1/2", "1/9", "1/16", "1/23", "1/30", "2/6", "2/13", "2/20", "2/27", "3/6", "3/13", "3/20", "3/27", "4/3", "4/10", "4/17", "4/24", "5/1", "5/8", "5/15", "5/22", "5/29", "6/5", "6/12", "6/18", "6/26", "7/2", "7/10", "7/17", "7/24", "7/31"], "fleet": {"7/31": 50739.05, "7/24": 41260.19, "7/17": 46066.36, "7/10": 41498.38, "7/2": 42532.09, "6/26": 50461.1, "6/18": 43913.08, "6/12": 58793.41, "6/5": 49118.13, "5/29": 49252.77, "5/22": 51419.11, "5/15": 50330.54, "5/8": 49556.54, "5/1": 49503.33, "4/24": 51015.57, "4/17": 46630.36, "4/10": 39349.62, "4/3": 37057.28, "3/27": 45657.72, "3/20": 51703.62, "3/13": 42133.77, "3/6": 41662.99, "2/27": 28994.95, "2/20": 30445.98, "2/13": 29968.49, "2/6": 29111.74, "1/30": 30551.74, "1/23": 33819.59, "1/16": 33857.97, "1/9": 22539.18, "1/2": 16454.92}, "otr": {"7/31": 17266.3, "7/24": 14836.22, "7/17": 15641.4, "7/10": 14707.16, "7/2": 14636.94, "6/26": 16676.68, "6/18": 10077.48, "6/12": 8673.09, "6/5": 7390.99, "5/29": 6842.63, "5/22": 6434.68, "5/15": 2282.77, "5/8": 1983.39, "5/1": 1929.97, "4/24": 2486.28, "4/17": 1582.97, "4/10": 2061.51, "4/3": 1617.79, "3/27": 1747.42, "3/20": 2493.37, "3/13": 1575.28, "3/6": 2213.55, "2/27": 2044.08, "2/20": 1956.26, "2/13": 2088.54, "2/6": 1835.31, "1/30": 1981.94, "1/23": 1570.75, "1/16": 1292.94}};

const OFFICE_PAYCHECKS = {"source":"W-2 paychecks (loaded) + contractors NET cash (car/health/commission in dropdown) \u00b7 31 weeks \u00b7 columns = pay day \u00b7 accumulated (never overwrites prior weeks)","weeks":["1/2","1/9","1/16","1/23","1/30","2/6","2/13","2/20","2/27","3/6","3/13","3/20","3/27","4/3","4/10","4/17","4/24","5/1","5/8","5/15","5/22","5/29","6/5","6/12","6/18","6/26","7/2","7/10","7/17","7/24","7/31"],"sections":[{"name":"CE","rows":[{"name":"Galvis, Harold A (50%)","former":false,"amts":{"6/5":627.15,"6/12":627.15,"6/18":627.15,"6/26":627.15,"7/2":627.15,"7/10":627.15,"7/17":677.1,"7/24":627.15,"7/31":627.15},"camts":{},"net":{"6/5":439.93,"6/12":439.93,"6/18":439.93,"6/26":439.93,"7/2":439.93,"7/10":439.93,"7/17":484.93,"7/24":439.93,"7/31":439.93},"gross":{"6/5":565.0,"6/12":565.0,"6/18":565.0,"6/26":565.0,"7/2":565.0,"7/10":565.0,"7/17":610.0,"7/24":565.0,"7/31":565.0},"car":{},"health":{},"commission":{},"reimb":{},"total":5694.3},{"name":"Gelaw, Kidist B (50%)","former":false,"amts":{"6/12":627.15,"6/18":627.15,"6/26":627.15,"7/2":627.15,"7/10":627.15,"7/17":627.15,"7/24":627.15,"7/31":627.15},"camts":{},"net":{"6/12":474.94,"6/18":474.94,"6/26":474.94,"7/2":474.94,"7/10":474.94,"7/17":474.94,"7/24":474.94,"7/31":474.94},"gross":{"6/12":565.0,"6/18":565.0,"6/26":565.0,"7/2":565.0,"7/10":565.0,"7/17":565.0,"7/24":565.0,"7/31":565.0},"car":{},"health":{},"commission":{},"reimb":{},"total":5017.2},{"name":"Rivera, Cecilia I","former":false,"amts":{"1/9":1426.35,"1/16":1426.35,"1/23":1426.35,"1/30":1426.35,"2/6":1426.35,"2/13":1426.35,"2/20":1665.0,"2/27":1665.0,"3/6":1426.35,"3/13":1426.35,"3/20":1426.35,"3/27":1426.35,"4/3":1426.35,"4/10":1665.0,"4/17":1426.35,"4/24":1426.35,"5/1":1426.35,"5/8":1665.0,"5/15":1426.35,"5/22":1426.35,"5/29":1443.0,"6/5":1443.0,"6/12":1720.5,"6/18":1665.0,"6/26":1665.0,"7/2":1665.0,"7/10":1665.0,"7/17":1665.0,"7/24":1665.0,"7/31":1665.0},"camts":{},"net":{"1/9":1135.3,"1/16":1135.29,"1/23":1135.3,"1/30":1135.3,"2/6":1135.3,"2/13":1135.29,"2/20":1325.25,"2/27":1325.25,"3/6":1135.3,"3/13":1135.3,"3/20":1135.3,"3/27":1135.29,"4/3":1135.3,"4/10":1325.25,"4/17":1135.3,"4/24":1135.3,"5/1":1135.29,"5/8":1325.25,"5/15":1135.3,"5/22":1135.3,"5/29":1150.3,"6/5":1150.29,"6/12":1371.18,"6/18":1325.25,"6/26":1325.25,"7/2":1325.25,"7/10":1325.25,"7/17":1325.25,"7/24":1325.25,"7/31":1325.25},"gross":{"1/9":1285.0,"1/16":1285.0,"1/23":1285.0,"1/30":1285.0,"2/6":1285.0,"2/13":1285.0,"2/20":1500.0,"2/27":1500.0,"3/6":1285.0,"3/13":1285.0,"3/20":1285.0,"3/27":1285.0,"4/3":1285.0,"4/10":1500.0,"4/17":1285.0,"4/24":1285.0,"5/1":1285.0,"5/8":1500.0,"5/15":1285.0,"5/22":1285.0,"5/29":1300.0,"6/5":1300.0,"6/12":1550.0,"6/18":1500.0,"6/26":1500.0,"7/2":1500.0,"7/10":1500.0,"7/17":1500.0,"7/24":1500.0,"7/31":1500.0},"car":{},"health":{},"commission":{},"reimb":{},"total":45743.1},{"name":"Youngblood, Nathan","former":false,"amts":{"1/9":1332.0,"1/16":1332.0,"1/23":1332.0,"1/30":1332.0,"2/6":1332.0,"2/13":1332.0,"2/20":1332.0,"2/27":1332.0,"3/6":1332.0,"3/13":1332.0,"3/20":1332.0,"3/27":1332.0,"4/3":1332.0,"4/10":1332.0,"4/17":1332.0,"4/24":1332.0,"5/1":1332.0,"5/8":1332.0,"5/15":1332.0,"5/22":1332.0,"5/29":1332.0,"6/5":1332.0,"6/12":1332.0,"6/18":1332.0,"6/26":1332.0,"7/2":1332.0,"7/10":1332.0,"7/17":1332.0,"7/24":1332.0,"7/31":1443.0},"camts":{},"net":{"1/9":815.97,"1/16":815.97,"1/23":815.97,"1/30":815.97,"2/6":815.97,"2/13":815.97,"2/20":815.97,"2/27":815.97,"3/6":815.97,"3/13":815.97,"3/20":815.97,"3/27":815.97,"4/3":815.97,"4/10":815.97,"4/17":815.97,"4/24":815.97,"5/1":815.97,"5/8":815.97,"5/15":815.97,"5/22":815.97,"5/29":815.97,"6/5":815.97,"6/12":815.97,"6/18":815.97,"6/26":815.97,"7/2":815.97,"7/10":815.97,"7/17":815.97,"7/24":815.97,"7/31":894.21},"gross":{"1/9":1200.0,"1/16":1200.0,"1/23":1200.0,"1/30":1200.0,"2/6":1200.0,"2/13":1200.0,"2/20":1200.0,"2/27":1200.0,"3/6":1200.0,"3/13":1200.0,"3/20":1200.0,"3/27":1200.0,"4/3":1200.0,"4/10":1200.0,"4/17":1200.0,"4/24":1200.0,"5/1":1200.0,"5/8":1200.0,"5/15":1200.0,"5/22":1200.0,"5/29":1200.0,"6/5":1200.0,"6/12":1200.0,"6/18":1200.0,"6/26":1200.0,"7/2":1200.0,"7/10":1200.0,"7/17":1200.0,"7/24":1200.0,"7/31":1300.0},"car":{},"health":{},"commission":{},"reimb":{},"total":40071.0},{"name":"Gabriel Colon \u00b7 1099 (50%)","former":false,"amts":{},"camts":{"1/9":1000.0,"1/16":1212.81,"1/23":1000.0,"1/30":1000.0,"2/6":1174.98,"2/13":1220.31,"2/20":1177.48,"2/27":1184.14,"3/6":1178.82,"3/13":1000.0,"3/20":1125.82,"3/27":1099.99,"4/3":1416.65,"4/10":1250.0,"4/17":1000.0,"4/24":1123.82,"5/1":1105.32,"5/8":1000.0,"5/15":1165.82,"5/22":1000.0,"5/29":1000.0,"6/5":1066.66,"6/12":1100.0,"6/18":1000.0,"6/26":1145.32,"7/2":1000.0,"7/10":1174.15,"7/24":1500.0,"7/31":1500.0},"net":{},"gross":{},"car":{},"health":{},"commission":{},"reimb":{},"total":32922.09},{"name":"Jon Marcus \u00b7 1099","former":false,"amts":{},"camts":{"1/9":2800.0,"1/16":2800.0,"1/23":2800.0,"1/30":3150.0,"2/6":2800.0,"2/13":2800.0,"2/20":2800.0,"2/27":3150.0,"3/6":2800.0,"3/13":2800.0,"3/20":2800.0,"3/27":2800.0,"4/3":350.0,"4/10":2800.0,"4/17":2800.0,"4/24":2800.0,"5/1":350.0,"5/8":2800.0,"5/15":2800.0,"5/22":2800.0,"5/29":350.0,"6/5":2800.0,"6/12":2800.0,"6/18":2800.0,"6/26":2800.0,"7/2":2800.0,"7/10":2800.0,"7/17":2800.0,"7/24":2800.0,"7/31":2800.0},"net":{},"gross":{},"car":{"1/9":350.0,"2/6":350.0,"3/6":350.0,"4/10":350.0,"5/8":350.0,"7/2":350.0,"7/31":350.0},"health":{},"commission":{},"reimb":{},"total":79800.0},{"name":"Mairena Tapias \u00b7 1099","former":false,"amts":{},"camts":{"4/24":193.04,"5/8":900.0,"5/22":882.0,"5/29":695.0,"6/5":140.0,"6/12":950.0,"6/18":475.0,"6/26":475.0,"7/2":956.0,"7/10":478.0,"7/17":478.0,"7/24":478.0,"7/31":478.0},"net":{},"gross":{},"car":{},"health":{},"commission":{},"reimb":{},"total":7578.04},{"name":"Naruszewicz, Bartosz (50%)","former":true,"amts":{"5/8":979.19,"5/15":991.17,"5/22":1165.5,"5/29":999.0,"6/5":999.0,"6/12":999.0,"6/18":1064.43,"6/26":1042.96,"7/2":999.0,"7/10":832.5},"camts":{},"net":{"5/8":705.5,"5/15":713.1,"5/22":823.58,"5/29":718.05,"6/5":718.05,"6/12":718.05,"6/18":759.52,"6/26":745.91,"7/2":718.05,"7/10":612.53},"gross":{"5/8":882.15,"5/15":892.95,"5/22":1050.0,"5/29":900.0,"6/5":900.0,"6/12":900.0,"6/18":958.95,"6/26":939.6,"7/2":900.0,"7/10":750.0},"car":{},"health":{},"commission":{},"reimb":{},"total":10071.75}],"totals":{"1/9":2758.35,"1/16":2758.35,"1/23":2758.35,"1/30":2758.35,"2/6":2758.35,"2/13":2758.35,"2/20":2997.0,"2/27":2997.0,"3/6":2758.35,"3/13":2758.35,"3/20":2758.35,"3/27":2758.35,"4/3":2758.35,"4/10":2997.0,"4/17":2758.35,"4/24":2758.35,"5/1":2758.35,"5/8":3976.19,"5/15":3749.52,"5/22":3923.85,"5/29":3774.0,"6/5":4401.15,"6/12":5305.8,"6/18":5315.73,"6/26":5294.26,"7/2":5250.3,"7/10":5083.8,"7/17":4301.25,"7/24":4251.3,"7/31":4362.3},"ctotals":{"1/9":3800.0,"1/16":4012.81,"1/23":3800.0,"1/30":4150.0,"2/6":3974.98,"2/13":4020.31,"2/20":3977.48,"2/27":4334.14,"3/6":3978.82,"3/13":3800.0,"3/20":3925.82,"3/27":3899.99,"4/3":1766.65,"4/10":4050.0,"4/17":3800.0,"4/24":4116.86,"5/1":1455.32,"5/8":4700.0,"5/15":3965.82,"5/22":4682.0,"5/29":2045.0,"6/5":4006.66,"6/12":4850.0,"6/18":4275.0,"6/26":4420.32,"7/2":4756.0,"7/10":4452.15,"7/17":3278.0,"7/24":4778.0,"7/31":4778.0},"ltotals":{"1/9":4150.0,"1/16":4012.81,"1/23":3800.0,"1/30":4150.0,"2/6":4324.98,"2/13":4020.31,"2/20":3977.48,"2/27":4334.14,"3/6":4328.82,"3/13":3800.0,"3/20":3925.82,"3/27":3899.99,"4/3":1766.65,"4/10":4400.0,"4/17":3800.0,"4/24":4116.86,"5/1":1455.32,"5/8":5050.0,"5/15":3965.82,"5/22":4682.0,"5/29":2045.0,"6/5":4006.66,"6/12":4850.0,"6/18":4275.0,"6/26":4420.32,"7/2":5106.0,"7/10":4452.15,"7/17":3278.0,"7/24":4778.0,"7/31":5128.0},"rtotals":{}},{"name":"SF","rows":[{"name":"Arias, Adrian","former":false,"amts":{"1/9":1827.06,"1/16":2131.57,"1/23":2131.57,"1/30":1827.06,"2/6":1827.06,"2/13":1827.06,"2/20":1827.06,"2/27":1827.06,"3/6":1827.06,"3/13":1827.06,"3/20":2631.81,"3/27":1827.06,"4/3":1827.06,"4/10":1827.06,"4/17":1827.06,"4/24":1827.06,"5/1":2131.2,"5/8":1827.06,"5/15":1827.06,"5/22":1827.06,"5/29":1827.06,"6/5":1827.06,"6/12":1827.06,"6/18":1827.06,"6/26":2132.31,"7/2":1827.06,"7/10":1827.06,"7/17":2132.31,"7/24":1827.06,"7/31":1827.06},"camts":{},"net":{"1/9":1423.28,"1/16":1625.86,"1/23":1625.85,"1/30":1423.29,"2/6":1423.27,"2/13":1173.28,"2/20":1173.29,"2/27":1173.28,"3/6":1173.28,"3/13":1173.27,"3/20":1994.38,"3/27":1423.29,"4/3":1423.28,"4/10":1423.28,"4/17":1423.28,"4/24":1423.28,"5/1":1625.63,"5/8":1423.28,"5/15":1423.29,"5/22":1423.28,"5/29":1423.27,"6/5":1423.28,"6/12":1423.29,"6/18":1423.28,"6/26":1626.31,"7/2":1423.27,"7/10":1423.28,"7/17":1626.31,"7/24":1423.28,"7/31":1423.28},"gross":{"1/9":1646.0,"1/16":1920.33,"1/23":1920.33,"1/30":1646.0,"2/6":1646.0,"2/13":1646.0,"2/20":1646.0,"2/27":1646.0,"3/6":1646.0,"3/13":1646.0,"3/20":2371.0,"3/27":1646.0,"4/3":1646.0,"4/10":1646.0,"4/17":1646.0,"4/24":1646.0,"5/1":1920.0,"5/8":1646.0,"5/15":1646.0,"5/22":1646.0,"5/29":1646.0,"6/5":1646.0,"6/12":1646.0,"6/18":1646.0,"6/26":1921.0,"7/2":1646.0,"7/10":1646.0,"7/17":1921.0,"7/24":1646.0,"7/31":1646.0},"car":{},"health":{},"commission":{},"reimb":{},"total":57140.21},{"name":"Eagleton, Gentry J","former":false,"amts":{"1/9":893.66,"1/16":1275.95,"1/23":923.63,"1/30":968.25,"2/6":734.6,"2/13":903.54,"2/20":893.77,"2/27":877.9,"3/6":907.54,"3/13":1016.87,"3/20":900.88,"3/27":934.07,"4/3":1018.43,"4/10":1063.49,"4/17":977.91,"4/24":949.27,"5/1":949.27,"5/8":945.94,"5/15":891.0,"5/22":958.6,"5/29":1005.22,"6/5":912.98,"6/12":1025.86,"6/18":932.29,"6/26":1174.05,"7/2":1073.81,"7/10":1052.39,"7/17":888.0,"7/24":923.63,"7/31":2035.19},"camts":{},"net":{"1/9":688.82,"1/16":965.54,"1/23":710.51,"1/30":742.82,"2/6":573.69,"2/13":695.97,"2/20":688.9,"2/27":677.41,"3/6":698.87,"3/13":778.0,"3/20":694.06,"3/27":718.05,"4/3":779.14,"4/10":811.76,"4/17":749.79,"4/24":729.08,"5/1":729.08,"5/8":726.66,"5/15":686.9,"5/22":735.82,"5/29":789.22,"6/5":702.81,"6/12":784.52,"6/18":716.79,"6/26":891.78,"7/2":819.23,"7/10":803.73,"7/17":684.72,"7/24":710.51,"7/31":1691.98},"gross":{"1/9":805.1,"1/16":1149.5,"1/23":832.1,"1/30":872.3,"2/6":661.8,"2/13":814.0,"2/20":805.2,"2/27":790.9,"3/6":817.6,"3/13":916.1,"3/20":811.6,"3/27":841.5,"4/3":917.5,"4/10":958.1,"4/17":881.0,"4/24":855.2,"5/1":855.2,"5/8":852.2,"5/15":802.7,"5/22":863.6,"5/29":905.6,"6/5":822.5,"6/12":924.2,"6/18":839.9,"6/26":1057.7,"7/2":967.4,"7/10":948.1,"7/17":800.0,"7/24":832.1,"7/31":1833.5},"car":{},"health":{},"commission":{},"reimb":{},"total":30007.99},{"name":"Figueroa, Andres","former":false,"amts":{"1/2":1581.75,"1/9":1748.25,"1/16":1581.75,"1/23":1748.25,"1/30":1581.75,"2/6":1581.75,"2/13":1581.75,"2/20":1581.75,"2/27":1581.75,"3/6":1581.75,"3/13":1581.75,"3/20":1581.75,"3/27":1581.75,"4/3":1581.75,"4/10":1581.75,"4/17":1581.75,"4/24":1581.75,"5/1":1581.75,"5/8":1581.75,"5/15":1581.75,"5/22":1581.75,"5/29":1956.38,"6/5":1845.38,"6/12":1845.38,"6/18":1803.75,"6/26":1845.38,"7/2":1845.38,"7/10":1845.38,"7/17":1845.38,"7/24":1845.38,"7/31":2067.38},"camts":{},"net":{"1/2":1315.99,"1/9":1465.98,"1/16":1315.99,"1/23":1465.99,"1/30":1315.99,"2/6":1315.98,"2/13":1315.99,"2/20":1315.99,"2/27":1315.99,"3/6":1315.98,"3/13":1315.99,"3/20":1315.99,"3/27":1315.99,"4/3":1315.98,"4/10":1315.99,"4/17":1315.99,"4/24":1315.99,"5/1":1315.98,"5/8":1315.99,"5/15":1315.99,"5/22":1315.99,"5/29":1635.31,"6/5":1535.32,"6/12":1535.32,"6/18":1515.99,"6/26":1535.32,"7/2":1535.31,"7/10":1553.49,"7/17":1535.32,"7/24":1553.49,"7/31":1720.02},"gross":{"1/2":1425.0,"1/9":1575.0,"1/16":1425.0,"1/23":1575.0,"1/30":1425.0,"2/6":1425.0,"2/13":1425.0,"2/20":1425.0,"2/27":1425.0,"3/6":1425.0,"3/13":1425.0,"3/20":1425.0,"3/27":1425.0,"4/3":1425.0,"4/10":1425.0,"4/17":1425.0,"4/24":1425.0,"5/1":1425.0,"5/8":1425.0,"5/15":1425.0,"5/22":1425.0,"5/29":1762.5,"6/5":1662.5,"6/12":1662.5,"6/18":1625.0,"6/26":1662.5,"7/2":1662.5,"7/10":1662.5,"7/17":1662.5,"7/24":1662.5,"7/31":1862.5},"car":{},"health":{},"commission":{},"reimb":{},"total":52294.92},{"name":"Gonzalez, Gabriel","former":false,"amts":{"1/9":1174.04,"1/16":1174.04,"1/23":1451.54,"1/30":1174.04,"2/6":1174.04,"2/13":1174.04,"2/20":1174.04,"2/27":1332.0,"3/6":1332.0,"3/13":1332.0,"3/20":1332.0,"3/27":1332.0,"4/3":1332.0,"4/10":1332.0,"4/17":1332.0,"4/24":1366.41,"5/1":1332.0,"5/8":1332.0,"5/15":1332.0,"5/22":1332.0,"5/29":1332.0,"6/5":1332.0,"6/12":1332.0,"6/18":1332.0,"6/26":1332.0,"7/2":1332.0,"7/10":1332.0,"7/17":1332.0,"7/24":1332.0,"7/31":1332.0},"camts":{},"net":{"1/9":891.77,"1/16":891.79,"1/23":1089.77,"1/30":891.77,"2/6":891.78,"2/13":891.78,"2/20":891.77,"2/27":1006.12,"3/6":1006.12,"3/13":1006.12,"3/20":1006.12,"3/27":1006.12,"4/3":1006.12,"4/10":1006.12,"4/17":1006.12,"4/24":1037.12,"5/1":1006.12,"5/8":1006.12,"5/15":1006.12,"5/22":1006.12,"5/29":1006.12,"6/5":1006.12,"6/12":1006.12,"6/18":1006.12,"6/26":1006.12,"7/2":1006.12,"7/10":1006.12,"7/17":1006.12,"7/24":1006.12,"7/31":1006.12},"gross":{"1/9":1057.69,"1/16":1057.69,"1/23":1307.69,"1/30":1057.69,"2/6":1057.69,"2/13":1057.69,"2/20":1057.69,"2/27":1200.0,"3/6":1200.0,"3/13":1200.0,"3/20":1200.0,"3/27":1200.0,"4/3":1200.0,"4/10":1200.0,"4/17":1200.0,"4/24":1231.0,"5/1":1200.0,"5/8":1200.0,"5/15":1200.0,"5/22":1200.0,"5/29":1200.0,"6/5":1200.0,"6/12":1200.0,"6/18":1200.0,"6/26":1200.0,"7/2":1200.0,"7/10":1200.0,"7/17":1200.0,"7/24":1200.0,"7/31":1200.0},"car":{},"health":{},"commission":{},"reimb":{},"total":39166.19},{"name":"Mahan, Tasha","former":false,"amts":{"6/5":1443.0,"6/12":1443.0,"6/18":1443.0,"6/26":1443.0,"7/2":1443.0,"7/10":1443.0,"7/17":1443.0,"7/24":1443.0,"7/31":1443.0},"camts":{},"net":{"6/5":1093.97,"6/12":1093.97,"6/18":1093.97,"6/26":1093.97,"7/2":1093.97,"7/10":1093.97,"7/17":1093.97,"7/24":1093.97,"7/31":1093.97},"gross":{"6/5":1300.0,"6/12":1300.0,"6/18":1300.0,"6/26":1300.0,"7/2":1300.0,"7/10":1300.0,"7/17":1300.0,"7/24":1300.0,"7/31":1300.0},"car":{},"health":{},"commission":{},"reimb":{},"total":12987.0},{"name":"Wilson, Antionette","former":false,"amts":{"6/26":1254.3,"7/2":1254.3,"7/10":1254.3,"7/17":1505.16,"7/24":1254.3,"7/31":1254.3},"camts":{},"net":{"6/26":949.87,"7/2":949.88,"7/10":949.87,"7/17":1158.59,"7/24":949.88,"7/31":949.87},"gross":{"6/26":1130.0,"7/2":1130.0,"7/10":1130.0,"7/17":1356.0,"7/24":1130.0,"7/31":1130.0},"car":{},"health":{},"commission":{},"reimb":{},"total":7776.66},{"name":"Gabriel Colon \u00b7 1099 (50%)","former":false,"amts":{},"camts":{"1/9":1000.0,"1/16":1212.81,"1/23":1000.0,"1/30":1000.0,"2/6":1174.98,"2/13":1220.31,"2/20":1177.48,"2/27":1184.14,"3/6":1178.82,"3/13":1000.0,"3/20":1125.82,"3/27":1099.99,"4/3":1416.65,"4/10":1250.0,"4/17":1000.0,"4/24":1123.82,"5/1":1105.32,"5/8":1000.0,"5/15":1165.82,"5/22":1000.0,"5/29":1000.0,"6/5":1066.66,"6/12":1100.0,"6/18":1000.0,"6/26":1145.32,"7/2":1000.0,"7/10":1174.14,"7/24":1500.0,"7/31":1500.0},"net":{},"gross":{},"car":{},"health":{},"commission":{},"reimb":{},"total":32922.08},{"name":"Maria Con \u00b7 1099","former":false,"amts":{},"camts":{"1/9":550.0,"1/16":550.0,"1/23":550.0,"1/30":550.0,"2/6":550.0,"2/13":550.0,"2/20":550.0,"2/27":550.0,"3/6":550.0,"3/13":550.0,"3/20":650.0,"3/27":650.0,"4/3":650.0,"4/10":650.0,"4/17":650.0,"4/24":650.0,"5/1":650.0,"5/8":650.0,"5/15":650.0,"5/22":650.0,"5/29":650.0,"6/5":650.0,"6/12":650.0,"6/18":650.0,"6/26":650.0,"7/2":650.0,"7/10":650.0,"7/17":650.0,"7/24":650.0,"7/31":650.0},"net":{},"gross":{},"car":{},"health":{},"commission":{},"reimb":{},"total":18500.0},{"name":"Grosser, Scot E","former":true,"amts":{"1/9":1856.26,"1/16":1856.26,"1/23":1856.26,"1/30":1856.26,"2/6":1856.26,"2/13":1856.26,"2/20":1856.26,"2/27":1856.26,"3/6":1856.26,"3/13":1856.26,"3/20":1856.26,"3/27":1856.26,"4/3":2115.26,"4/10":1856.26,"4/17":1856.26,"4/24":1856.26,"5/1":1856.26,"5/8":2114.89,"5/15":1930.73,"5/22":2072.37},"camts":{},"net":{"1/9":1125.45,"1/16":1125.46,"1/23":1125.45,"1/30":1125.44,"2/6":1125.46,"2/13":1125.45,"2/20":1125.45,"2/27":1125.46,"3/6":1125.45,"3/13":1125.44,"3/20":1125.46,"3/27":1125.45,"4/3":1303.05,"4/10":1125.45,"4/17":1125.44,"4/24":1125.46,"5/1":1125.45,"5/8":1302.82,"5/15":1192.54,"5/22":1424.99},"gross":{"1/9":1672.31,"1/16":1672.31,"1/23":1672.31,"1/30":1672.31,"2/6":1672.31,"2/13":1672.31,"2/20":1672.31,"2/27":1672.31,"3/6":1672.31,"3/13":1672.31,"3/20":1672.31,"3/27":1672.31,"4/3":1905.64,"4/10":1672.31,"4/17":1672.31,"4/24":1672.31,"5/1":1672.31,"5/8":1905.31,"5/15":1739.4,"5/22":1867.0},"car":{},"health":{},"commission":{},"reimb":{},"total":37933.41},{"name":"Naruszewicz, Bartosz (50%)","former":true,"amts":{"5/8":979.19,"5/15":991.17,"5/22":1165.5,"5/29":999.0,"6/5":999.0,"6/12":999.0,"6/18":1064.43,"6/26":1042.96,"7/2":999.0,"7/10":832.5},"camts":{},"net":{"5/8":705.5,"5/15":713.1,"5/22":823.58,"5/29":718.05,"6/5":718.05,"6/12":718.05,"6/18":759.52,"6/26":745.91,"7/2":718.05,"7/10":612.53},"gross":{"5/8":882.15,"5/15":892.95,"5/22":1050.0,"5/29":900.0,"6/5":900.0,"6/12":900.0,"6/18":958.95,"6/26":939.6,"7/2":900.0,"7/10":750.0},"car":{},"health":{},"commission":{},"reimb":{},"total":10071.75}],"totals":{"1/2":1581.75,"1/9":7499.27,"1/16":8019.57,"1/23":8111.25,"1/30":7407.36,"2/6":7173.71,"2/13":7342.65,"2/20":7332.88,"2/27":7474.97,"3/6":7504.61,"3/13":7613.94,"3/20":8302.7,"3/27":7531.14,"4/3":7874.5,"4/10":7660.56,"4/17":7574.98,"4/24":7580.75,"5/1":7850.48,"5/8":8780.83,"5/15":8553.71,"5/22":8937.28,"5/29":7119.66,"6/5":8359.42,"6/12":8472.3,"6/18":8402.53,"6/26":10224.0,"7/2":9774.55,"7/10":9586.63,"7/17":9145.85,"7/24":8625.37,"7/31":9958.93},"ctotals":{"1/9":1550.0,"1/16":1762.81,"1/23":1550.0,"1/30":1550.0,"2/6":1724.98,"2/13":1770.31,"2/20":1727.48,"2/27":1734.14,"3/6":1728.82,"3/13":1550.0,"3/20":1775.82,"3/27":1749.99,"4/3":2066.65,"4/10":1900.0,"4/17":1650.0,"4/24":1773.82,"5/1":1755.32,"5/8":1650.0,"5/15":1815.82,"5/22":1650.0,"5/29":1650.0,"6/5":1716.66,"6/12":1750.0,"6/18":1650.0,"6/26":1795.32,"7/2":1650.0,"7/10":1824.14,"7/17":650.0,"7/24":2150.0,"7/31":2150.0},"ltotals":{"1/9":1550.0,"1/16":1762.81,"1/23":1550.0,"1/30":1550.0,"2/6":1724.98,"2/13":1770.31,"2/20":1727.48,"2/27":1734.14,"3/6":1728.82,"3/13":1550.0,"3/20":1775.82,"3/27":1749.99,"4/3":2066.65,"4/10":1900.0,"4/17":1650.0,"4/24":1773.82,"5/1":1755.32,"5/8":1650.0,"5/15":1815.82,"5/22":1650.0,"5/29":1650.0,"6/5":1716.66,"6/12":1750.0,"6/18":1650.0,"6/26":1795.32,"7/2":1650.0,"7/10":1824.14,"7/17":650.0,"7/24":2150.0,"7/31":2150.0},"rtotals":{}},{"name":"CE East","rows":[{"name":"Galvis, Harold A (50%)","former":false,"amts":{"6/5":627.15,"6/12":627.15,"6/18":627.15,"6/26":627.15,"7/2":627.15,"7/10":627.15,"7/17":677.1,"7/24":627.15,"7/31":627.15},"camts":{},"net":{"6/5":439.93,"6/12":439.93,"6/18":439.93,"6/26":439.93,"7/2":439.93,"7/10":439.93,"7/17":484.93,"7/24":439.93,"7/31":439.93},"gross":{"6/5":565.0,"6/12":565.0,"6/18":565.0,"6/26":565.0,"7/2":565.0,"7/10":565.0,"7/17":610.0,"7/24":565.0,"7/31":565.0},"car":{},"health":{},"commission":{},"reimb":{},"total":5694.3},{"name":"Gelaw, Kidist B (50%)","former":false,"amts":{"6/12":627.15,"6/18":627.15,"6/26":627.15,"7/2":627.15,"7/10":627.15,"7/17":627.15,"7/24":627.15,"7/31":627.15},"camts":{},"net":{"6/12":474.94,"6/18":474.94,"6/26":474.94,"7/2":474.94,"7/10":474.94,"7/17":474.94,"7/24":474.94,"7/31":474.94},"gross":{"6/12":565.0,"6/18":565.0,"6/26":565.0,"7/2":565.0,"7/10":565.0,"7/17":565.0,"7/24":565.0,"7/31":565.0},"car":{},"health":{},"commission":{},"reimb":{},"total":5017.2}],"totals":{"6/5":627.15,"6/12":1254.3,"6/18":1254.3,"6/26":1254.3,"7/2":1254.3,"7/10":1254.3,"7/17":1304.25,"7/24":1254.3,"7/31":1254.3},"ctotals":{},"ltotals":{},"rtotals":{}},{"name":"J&A","rows":[{"name":"Abrego, Valeria","former":false,"amts":{"1/9":888.0,"1/16":888.0,"1/23":888.0,"1/30":888.0,"2/6":888.0,"2/13":888.0,"2/20":888.0,"2/27":888.0,"3/6":888.0,"3/13":888.0,"3/20":1071.15,"3/27":910.31,"4/3":888.0,"4/10":1026.75,"4/17":888.0,"4/24":888.0,"5/1":888.0,"5/8":1043.4,"5/15":888.0,"5/22":888.0,"5/29":888.0,"6/5":1110.0,"6/12":999.0,"6/18":888.0,"6/26":888.0,"7/2":888.0,"7/10":888.0,"7/17":888.0,"7/24":888.0,"7/31":888.0},"camts":{},"net":{"1/9":684.72,"1/16":684.72,"1/23":684.72,"1/30":684.72,"2/6":684.72,"2/13":684.72,"2/20":684.72,"2/27":684.72,"3/6":684.72,"3/13":684.72,"3/20":817.3,"3/27":700.87,"4/3":684.72,"4/10":809.72,"4/17":684.72,"4/24":684.72,"5/1":684.72,"5/8":824.72,"5/15":684.72,"5/22":684.72,"5/29":684.72,"6/5":884.72,"6/12":784.72,"6/18":684.72,"6/26":684.72,"7/2":684.72,"7/10":684.72,"7/17":684.72,"7/24":684.72,"7/31":684.72},"gross":{"1/9":800.0,"1/16":800.0,"1/23":800.0,"1/30":800.0,"2/6":800.0,"2/13":800.0,"2/20":800.0,"2/27":800.0,"3/6":800.0,"3/13":800.0,"3/20":965.0,"3/27":820.1,"4/3":800.0,"4/10":925.0,"4/17":800.0,"4/24":800.0,"5/1":800.0,"5/8":940.0,"5/15":800.0,"5/22":800.0,"5/29":800.0,"6/5":1000.0,"6/12":900.0,"6/18":800.0,"6/26":800.0,"7/2":800.0,"7/10":800.0,"7/17":800.0,"7/24":800.0,"7/31":800.0},"car":{},"health":{},"commission":{},"reimb":{},"total":27472.61},{"name":"Adamson, Christopher","former":false,"amts":{"2/6":2220.0,"2/13":2220.0,"2/20":2220.0,"2/27":2220.0,"3/6":2220.0,"3/13":2220.0,"3/20":2220.0,"3/27":2220.0,"4/3":2220.0,"4/10":2220.0,"4/17":2220.0,"4/24":2220.0,"5/1":2220.0,"5/8":2220.0,"5/15":2220.0,"5/22":2220.0,"5/29":2220.0,"6/5":2220.0,"6/12":2220.0,"6/18":2220.0,"6/26":2220.0,"7/2":2220.0,"7/10":2220.0,"7/17":2220.0,"7/24":2220.0,"7/31":2220.0},"camts":{},"net":{"2/6":1004.41,"2/13":1004.41,"2/20":1004.41,"2/27":1004.41,"3/6":1004.41,"3/13":1004.41,"3/20":1004.41,"3/27":1004.41,"4/3":1004.41,"4/10":1004.41,"4/17":1004.41,"4/24":1004.41,"5/1":988.81,"5/8":988.81,"5/15":988.81,"5/22":988.81,"5/29":988.81,"6/5":988.81,"6/12":988.81,"6/18":988.81,"6/26":988.81,"7/2":988.81,"7/10":988.81,"7/17":988.81,"7/24":988.81,"7/31":988.81},"gross":{"2/6":2000.0,"2/13":2000.0,"2/20":2000.0,"2/27":2000.0,"3/6":2000.0,"3/13":2000.0,"3/20":2000.0,"3/27":2000.0,"4/3":2000.0,"4/10":2000.0,"4/17":2000.0,"4/24":2000.0,"5/1":2000.0,"5/8":2000.0,"5/15":2000.0,"5/22":2000.0,"5/29":2000.0,"6/5":2000.0,"6/12":2000.0,"6/18":2000.0,"6/26":2000.0,"7/2":2000.0,"7/10":2000.0,"7/17":2000.0,"7/24":2000.0,"7/31":2000.0},"car":{},"health":{},"commission":{},"reimb":{},"total":57720.0},{"name":"Dillon, Abigail","former":false,"amts":{"1/16":325.23,"1/23":187.31,"1/30":174.27,"2/6":271.12,"2/13":273.89,"2/20":56.89,"2/27":189.26,"3/6":277.22,"3/13":445.39,"3/20":169.83,"4/3":141.53,"4/10":527.81,"4/17":729.97,"4/24":222.0},"camts":{},"net":{"1/16":256.38,"1/23":154.45,"1/30":144.78,"2/6":216.62,"2/13":218.69,"2/20":47.33,"2/27":155.88,"3/6":221.15,"3/13":343.36,"3/20":141.31,"4/3":117.74,"4/10":403.02,"4/17":547.56,"4/24":180.18},"gross":{"1/16":293.0,"1/23":168.75,"1/30":157.0,"2/6":244.25,"2/13":246.75,"2/20":51.25,"2/27":170.5,"3/6":249.75,"3/13":401.25,"3/20":153.0,"4/3":127.5,"4/10":475.5,"4/17":657.63,"4/24":200.0},"car":{},"health":{},"commission":{},"reimb":{},"total":3991.72},{"name":"Hoffman, Ben","former":false,"amts":{"1/9":1494.24,"1/16":1494.24,"1/23":1494.24,"1/30":1494.24,"2/6":1494.24,"2/13":1494.24,"2/20":1494.24,"2/27":1494.24,"3/6":1494.24,"3/13":1494.24,"3/20":1494.24,"3/27":1494.24,"4/3":1494.24,"4/10":1494.24,"4/17":1494.24,"4/24":1538.64,"5/1":1494.24,"5/8":1494.24,"5/15":1494.24,"5/22":1494.24,"5/29":1494.24,"6/5":1494.24,"6/12":1494.24,"6/18":1494.24,"6/26":1682.94,"7/2":1494.24,"7/10":1716.24,"7/17":1494.24,"7/24":1494.24,"7/31":1494.24},"camts":{},"net":{"1/9":991.64,"1/16":980.6,"1/23":980.59,"1/30":1074.83,"2/6":1074.83,"2/13":1074.83,"2/20":1074.83,"2/27":1116.83,"3/6":1116.83,"3/13":1116.83,"3/20":1116.83,"3/27":1116.83,"4/3":1116.83,"4/10":1116.82,"4/17":1116.83,"4/24":1156.83,"5/1":1116.83,"5/8":1116.83,"5/15":1116.82,"5/22":1116.83,"5/29":1116.83,"6/5":1116.83,"6/12":1116.84,"6/18":1116.82,"6/26":1286.83,"7/2":1116.83,"7/10":1316.83,"7/17":1116.83,"7/24":1116.82,"7/31":1116.83},"gross":{"1/9":1346.16,"1/16":1346.16,"1/23":1346.16,"1/30":1346.16,"2/6":1346.16,"2/13":1346.16,"2/20":1346.16,"2/27":1346.16,"3/6":1346.16,"3/13":1346.16,"3/20":1346.16,"3/27":1346.16,"4/3":1346.16,"4/10":1346.16,"4/17":1346.16,"4/24":1386.16,"5/1":1346.16,"5/8":1346.16,"5/15":1346.16,"5/22":1346.16,"5/29":1346.16,"6/5":1346.16,"6/12":1346.16,"6/18":1346.16,"6/26":1516.16,"7/2":1346.16,"7/10":1546.16,"7/17":1346.16,"7/24":1346.16,"7/31":1346.16},"car":{},"health":{},"commission":{},"reimb":{},"total":45282.3},{"name":"Law, Joshua","former":false,"amts":{"7/2":3225.85,"7/10":2561.54,"7/17":2561.54,"7/24":2561.54,"7/31":2561.54},"camts":{},"net":{"7/2":2621.17,"7/10":2022.7,"7/17":2022.69,"7/24":2022.68,"7/31":2022.7},"gross":{"7/2":2906.17,"7/10":2307.69,"7/17":2307.69,"7/24":2307.69,"7/31":2307.69},"car":{},"health":{},"commission":{},"reimb":{},"total":13472.01},{"name":"Erika Valencio \u00b7 1099","former":false,"amts":{},"camts":{"7/10":1730.0,"7/17":1730.0,"7/24":1730.0,"7/31":1730.0},"net":{},"gross":{},"car":{},"health":{},"commission":{},"reimb":{},"total":6920.0},{"name":"Hilda Salman \u00b7 1099","former":false,"amts":{},"camts":{"1/9":1730.0,"1/16":1730.0,"1/23":1730.0,"1/30":1730.0,"2/6":1730.0,"2/13":1730.0,"2/20":1730.0,"2/27":1730.0,"3/6":1730.0,"3/13":1730.0,"3/20":1730.0,"3/27":1730.0,"4/3":1730.0,"4/10":1730.0,"4/17":1730.0,"4/24":1730.0,"5/1":1730.0,"5/8":1730.0,"5/15":1730.0,"5/22":1730.0,"5/29":1730.0,"6/5":1730.0,"6/12":1730.0,"6/18":1730.0,"6/26":1730.0,"7/2":1730.0,"7/10":1730.0,"7/17":1730.0,"7/24":1730.0,"7/31":1730.0},"net":{},"gross":{},"car":{},"health":{"1/9":118.82,"1/16":118.82,"1/23":118.82,"1/30":118.82,"2/6":118.82,"2/13":118.82,"2/20":118.82,"2/27":118.82,"3/6":118.82,"3/13":118.82,"3/20":118.82,"3/27":118.82,"4/3":118.82,"4/10":118.82,"4/17":118.82,"4/24":118.82,"5/1":118.82,"5/8":118.82,"5/15":118.82,"5/22":118.82,"5/29":118.82,"6/5":118.82,"6/12":118.82,"6/18":118.82,"6/26":118.82,"7/2":118.82,"7/10":118.82,"7/17":118.82,"7/24":118.82,"7/31":118.82},"commission":{},"reimb":{},"total":55464.6},{"name":"Kacy Richardson \u00b7 1099","former":false,"amts":{},"camts":{"7/17":500.0,"7/24":500.0,"7/31":500.0},"net":{},"gross":{},"car":{},"health":{},"commission":{},"reimb":{},"total":1500.0},{"name":"Logic Consultants \u00b7 1099","former":false,"amts":{},"camts":{"1/9":500.0,"1/16":500.0,"1/23":500.0,"1/30":500.0,"2/6":500.0,"2/13":500.0,"2/20":500.0,"2/27":500.0,"3/6":500.0,"3/13":500.0,"3/20":500.0,"3/27":500.0,"4/3":500.0,"4/10":500.0,"4/17":500.0,"4/24":500.0,"5/1":500.0,"5/8":500.0,"5/15":500.0,"5/22":500.0,"5/29":500.0,"6/5":500.0,"6/12":500.0,"6/18":500.0,"6/26":500.0,"7/2":500.0,"7/10":500.0,"7/17":500.0,"7/24":500.0,"7/31":500.0},"net":{},"gross":{},"car":{},"health":{},"commission":{},"reimb":{},"total":15000.0},{"name":"Mellody Abrego \u00b7 1099","former":false,"amts":{},"camts":{"1/9":2150.0,"1/16":2150.0,"1/23":2150.0,"1/30":2150.0,"2/6":2150.0,"2/13":2150.0,"2/20":4183.21,"2/27":2150.0,"3/6":2150.0,"3/13":2150.0,"3/20":2150.0,"3/27":2150.0,"4/3":2150.0,"4/10":2150.0,"4/17":2150.0,"4/24":2150.0,"5/1":2150.0,"5/8":2150.0,"5/15":1000.0,"5/22":2550.0,"5/29":2550.0,"6/5":2550.0,"6/12":2550.0,"6/18":2550.0,"6/26":2250.0,"7/2":2250.0,"7/10":2250.0,"7/17":3130.86,"7/24":2250.0,"7/31":2250.0},"net":{},"gross":{},"car":{"1/9":334.86,"2/6":334.86,"3/6":334.86,"4/10":334.86,"5/8":334.86,"6/5":684.86,"7/2":334.86},"health":{"1/9":368.34,"1/16":368.34,"1/23":368.34,"1/30":368.34,"2/6":368.34,"2/13":368.34,"2/20":368.34,"2/27":368.34,"3/6":368.34,"3/13":368.34,"3/20":368.34,"3/27":368.34,"4/3":368.34,"4/10":368.34,"4/17":368.34,"4/24":368.34,"5/1":368.34,"5/8":368.34,"5/15":368.34,"5/22":368.34,"5/29":368.34,"6/5":368.34,"6/12":368.34,"6/18":368.34,"6/26":368.34,"7/2":368.34,"7/10":368.34,"7/17":368.34,"7/24":368.34,"7/31":368.34},"commission":{"1/9":320.83,"1/16":320.83,"1/23":320.83,"1/30":320.83,"2/6":320.83,"2/13":320.83,"2/20":320.83,"2/27":320.83,"3/6":320.83,"3/13":320.83,"3/20":320.83,"3/27":190.12,"4/3":190.12,"4/10":190.12,"4/17":190.12,"4/24":190.12,"5/1":190.12,"5/8":190.12,"5/15":320.83,"5/22":190.12,"5/29":190.12,"6/5":190.12,"6/12":190.12,"6/18":190.12,"6/26":1283.3,"7/2":1283.3,"7/10":1283.3,"7/17":1283.31},"reimb":{"4/24":91.64,"5/1":247.97,"5/15":194.43},"total":93872.9},{"name":"Adamson, Debra","former":true,"amts":{"1/9":1387.5,"1/16":1387.5,"1/23":1387.5,"1/30":1387.5,"2/6":1387.5,"2/13":1387.5,"2/20":1387.5},"camts":{"2/27":1184.97,"3/6":1184.97,"3/13":1184.97,"6/26":1750.0,"7/2":1750.0,"7/10":1750.0,"7/17":1750.0,"7/24":1750.0,"7/31":1750.0},"net":{"1/9":1012.04,"1/16":1012.04,"1/23":1025.64,"1/30":1025.64,"2/6":1016.03,"2/13":1016.03,"2/20":1016.03},"gross":{"1/9":1250.0,"1/16":1250.0,"1/23":1250.0,"1/30":1250.0,"2/6":1250.0,"2/13":1250.0,"2/20":1250.0},"car":{},"health":{"1/9":53.79,"1/16":53.79,"1/23":53.79,"1/30":53.79,"2/6":53.79,"2/13":53.79,"2/20":53.79,"2/27":53.79,"3/6":53.79,"3/13":53.79,"3/20":53.79,"3/27":53.79,"4/3":53.79,"4/10":53.79,"4/17":53.79,"4/24":53.79,"5/1":53.79,"5/8":53.79,"5/15":53.79,"5/22":53.79,"5/29":53.79,"6/5":53.79,"6/12":53.79,"6/18":53.79,"6/26":53.79,"7/2":53.79,"7/10":53.79,"7/17":53.79,"7/24":53.79,"7/31":53.79},"commission":{},"reimb":{},"total":25381.11},{"name":"Delgado, Elizabeth G","former":true,"amts":{"1/9":999.0,"1/16":841.52,"1/23":1338.36,"1/30":1262.77,"2/6":1163.24,"2/13":2033.25,"2/20":1842.49},"camts":{"2/27":1045.53,"3/6":2056.84,"3/13":1155.23,"3/20":1098.16,"6/26":900.0,"7/2":900.0,"7/10":900.0,"7/17":2661.71,"7/24":900.0,"7/31":900.0},"net":{"1/9":774.69,"1/16":660.7,"1/23":1034.57,"1/30":1012.32,"2/6":922.65,"2/13":1558.82,"2/20":1386.96},"gross":{"1/9":900.0,"1/16":758.13,"1/23":1205.73,"1/30":1137.63,"2/6":1047.96,"2/13":1831.76,"2/20":1659.9},"car":{},"health":{},"commission":{"2/27":449.7,"3/6":449.7,"3/13":449.7,"3/20":449.7,"6/26":899.4,"7/2":899.4,"7/10":899.4,"7/17":899.42},"reimb":{"7/17":50.32,"7/24":253.25},"total":27394.52},{"name":"Fissehaye, Biniyam G","former":true,"amts":{"2/6":1528.55,"2/13":1498.5,"2/20":1498.5,"2/27":1498.5,"3/6":1498.5,"3/13":1498.5,"3/20":1498.5,"3/27":1498.5,"4/3":1498.5,"4/10":1498.5,"4/17":1498.5,"4/24":1498.5,"5/1":1665.0,"5/8":1498.5},"camts":{"6/26":1850.0,"7/2":1850.0,"7/10":1850.0,"7/17":1850.0,"7/24":1850.0,"7/31":1850.0},"net":{"2/6":1146.6,"2/13":1119.54,"2/20":1119.53,"2/27":1119.54,"3/6":1119.53,"3/13":1119.54,"3/20":1119.53,"3/27":1119.54,"4/3":1119.53,"4/10":1119.54,"4/17":1119.53,"4/24":1119.54,"5/1":1269.53,"5/8":1119.54},"gross":{"2/6":1377.07,"2/13":1350.0,"2/20":1350.0,"2/27":1350.0,"3/6":1350.0,"3/13":1350.0,"3/20":1350.0,"3/27":1350.0,"4/3":1350.0,"4/10":1350.0,"4/17":1350.0,"4/24":1350.0,"5/1":1500.0,"5/8":1350.0},"car":{},"health":{},"commission":{},"reimb":{},"total":32275.55},{"name":"Hall, Kirsten","former":true,"amts":{"1/9":832.5,"1/16":832.5,"1/23":832.5},"camts":{},"net":{"1/9":468.0,"1/16":426.99,"1/23":426.98},"gross":{"1/9":750.0,"1/16":750.0,"1/23":750.0},"car":{},"health":{},"commission":{},"reimb":{},"total":2497.5},{"name":"Parnell, Branden A","former":true,"amts":{"1/9":1280.76,"1/16":1280.76,"1/23":1280.76,"1/30":2561.52},"camts":{},"net":{"1/9":1065.57,"1/16":1065.57,"1/23":1065.58,"1/30":2131.14},"gross":{"1/9":1153.84,"1/16":1153.84,"1/23":1153.84,"1/30":2307.68},"car":{},"health":{},"commission":{},"reimb":{},"total":6403.8},{"name":"Sanchez, Ayelen R","former":true,"amts":{"1/9":471.75,"1/16":493.95,"1/23":291.38,"2/6":751.2},"camts":{},"net":{"1/9":380.95,"1/16":397.41,"1/23":242.42,"2/6":593.41},"gross":{"1/9":425.0,"1/16":445.0,"1/23":262.5,"2/6":676.76},"car":{},"health":{},"commission":{},"reimb":{},"total":2008.28},{"name":"Simpson, Christopher","former":true,"amts":{"1/9":2120.99,"1/16":2120.99,"1/23":999.0,"1/30":999.0,"2/6":1374.66,"2/13":1374.66,"2/20":999.0},"camts":{"2/27":900.0,"3/6":1415.79,"3/13":1415.79,"3/20":900.0,"6/26":834.97,"7/2":834.97,"7/10":834.97,"7/17":1340.34,"7/24":834.97,"7/31":1104.97},"net":{"1/9":1619.31,"1/16":1619.3,"1/23":726.28,"1/30":726.26,"2/6":1025.26,"2/13":1025.27,"2/20":726.26},"gross":{"1/9":1910.8,"1/16":1910.8,"1/23":900.0,"1/30":900.0,"2/6":1238.43,"2/13":1238.43,"2/20":900.0},"car":{},"health":{"1/9":53.79,"1/16":53.79,"1/23":53.79,"1/30":53.79,"2/6":53.79,"2/13":53.79,"2/20":53.79,"2/27":53.79,"3/6":53.79,"3/13":53.79,"3/20":53.79,"3/27":53.79,"4/3":53.79,"4/10":53.79,"4/17":53.79,"4/24":53.79,"5/1":53.79,"5/8":53.79,"5/15":53.79,"5/22":53.79,"5/29":53.79,"6/5":53.79,"6/12":53.79,"6/18":53.79,"6/26":53.79,"7/2":53.79,"7/10":53.79,"7/17":53.79,"7/24":53.79,"7/31":53.79},"commission":{"2/27":318.9,"3/6":318.9,"3/13":318.9,"3/20":318.9,"6/26":637.8,"7/2":637.8,"7/10":637.8,"7/17":637.8},"reimb":{},"total":25845.57}],"totals":{"1/9":9474.74,"1/16":9664.69,"1/23":8699.05,"1/30":8767.3,"2/6":11078.51,"2/13":11170.04,"2/20":10386.62,"2/27":6290.0,"3/6":6377.96,"3/13":6546.13,"3/20":6453.72,"3/27":6123.05,"4/3":6242.27,"4/10":6767.3,"4/17":6830.71,"4/24":6367.14,"5/1":6267.24,"5/8":6256.14,"5/15":4602.24,"5/22":4602.24,"5/29":4602.24,"6/5":4824.24,"6/12":4713.24,"6/18":4602.24,"6/26":4790.94,"7/2":7828.09,"7/10":7385.78,"7/17":7163.78,"7/24":7163.78,"7/31":7163.78},"ctotals":{"1/9":4380.0,"1/16":4380.0,"1/23":4380.0,"1/30":4380.0,"2/6":4380.0,"2/13":4380.0,"2/20":6413.21,"2/27":7510.5,"3/6":9037.6,"3/13":8135.99,"3/20":6378.16,"3/27":4380.0,"4/3":4380.0,"4/10":4380.0,"4/17":4380.0,"4/24":4380.0,"5/1":4380.0,"5/8":4380.0,"5/15":3230.0,"5/22":4780.0,"5/29":4780.0,"6/5":4780.0,"6/12":4780.0,"6/18":4780.0,"6/26":9814.97,"7/2":9814.97,"7/10":11544.97,"7/17":15192.91,"7/24":12044.97,"7/31":12314.97},"ltotals":{"1/9":5309.6,"1/16":4974.74,"1/23":4974.74,"1/30":4974.74,"2/6":5309.6,"2/13":4974.74,"2/20":7007.95,"2/27":8105.24,"3/6":9967.2,"3/13":8730.73,"3/20":6972.9,"3/27":4974.74,"4/3":4974.74,"4/10":5309.6,"4/17":4974.74,"4/24":5066.38,"5/1":5222.71,"5/8":5309.6,"5/15":4019.17,"5/22":5374.74,"5/29":5374.74,"6/5":6059.6,"6/12":5374.74,"6/18":5374.74,"6/26":10409.71,"7/2":10744.57,"7/10":12139.71,"7/17":15837.97,"7/24":12892.96,"7/31":12909.71},"rtotals":{"4/24":91.64,"5/1":247.97,"5/15":194.43,"7/17":50.32,"7/24":253.25}}]};
...
const ATL_BILLING = {
  asOf: "Jul 31, 2026",
  loads: 184,
  revenue: 521388.39,      // sum of Invoice Amount ("ATLANTA 2026 - ALL LOADS THRU 7.31", subtotal rows excluded). Driver-less format, so per-driver breakdown below is HISTORICAL (May 4-29) and stale until format restores Driver column
  carrierPay: 141620.62,   // sum of Carrier Amount = EXTERNAL carrier pay only. 135 of 184 loads have blank Carrier Amount because SF hauled them itself (SF IS the carrier) — full income, no external carrier cost (SF's cost is in LABOR/FUEL fleet buckets). Blank ≠ pending.
  grossProfit: 379767.77,  // revenue − external carrier pay. SF-self-haul loads legitimately have no carrier deduction.
  grossMargin: 72.8,       // % — real brokerage margin (high because most loads ran on SF's own trucks, not outside carriers)
  // ⚠ Aug 3 drop: the sheet's OWN subtotals are STALE — its revenue SUM stops at
  // row 177 and omits the last seven 7/31 loads ($36,800); the carrier SUM

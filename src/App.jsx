...
let PAYROLL = [
  { name: "Alexander Christopher", hours: 1826.41, totalCost: 56945.02 },
  ...
  { name: "Brown Willie M", hours: 60.02, totalCost: 1736.08 },
  { name: "Butler Richard", hours: 382.40, totalCost: 11493.27, active: false },
  { name: "Camacho Stephen B", hours: 384.28, totalCost: 11097.35 },
  ...
  { name: "Cowsky Andrew", hours: 1008.74, totalCost: 30407.45 },
  { name: "Dalton Aaron", hours: 14.76, totalCost: 426.92 },
  { name: "Daniels Gerald W", hours: 1113.24, totalCost: 32952.21 },
  { name: "Davis Anthoni D", hours: 2262.49, totalCost: 79195.50 },
  { name: "Denman Samuel E", hours: 1787.28, totalCost: 59256.10 },
  { name: "Dixon Deon A", hours: 179.91, totalCost: 5303.90 },
  { name: "Dotch Brandon C", hours: 540.11, totalCost: 16130.43, active: false },
  { name: "Gray Stephen D", hours: 545.53, totalCost: 16493.35 },
  { name: "Gutierrez Danny", hours: 1608.66, totalCost: 51048.21 },
  { name: "Guzman Jose", hours: 2031.86, totalCost: 73800.79 },
  { name: "Howell Lawrence", hours: 85.33, totalCost: 2373.24, active: false },
  { name: "Ibarra Jose Pablo", hours: 1990.97, totalCost: 71342.08 },
  ...
  { name: "Lewis Steve", hours: 336.27, totalCost: 9716.15 },
  ...
  { name: "McDaniels James", hours: 535.14, totalCost: 15662.45 },
  ...
  { name: "Reyes Corey", hours: 998.57, totalCost: 28769.85 },
  { name: "Robinson Animashaun", hours: 1170.43, totalCost: 34214.10 },
  { name: "Ronkov Martin P", hours: 1786.70, totalCost: 51814.82 },
  ...
  { name: "Whipple Wallace", hours: 1939.65, totalCost: 62889.67 },
  { name: "Williams Tadaryl C", hours: 1773.59, totalCost: 52685.38 },
  { name: "Williams Will", hours: 1467.99, totalCost: 43774.61 },
  { name: "Willis Wali A", hours: 2087.11, totalCost: 72721.87 },
...
let FUEL = {
  // EFS only, Jan 1 - Aug 9, 2026 - fleet $665,037.19 (121,214.16 gal).
  // EFS report total $813,942.75 / 150,385.44 gal minus the 9 ATL cards $148,905.56 / 29,171.28 gal.
  // Fuel = ULSD + BDSL + CDSL + UNPR + UNRG (all fuel products; excludes DEF, fees, parking, CADV)
  // Excluded from per-driver mapping (still counted in FUEL_TOT): card 17408 ($7,409.20), card 07409 ($6,613.18), card 17468 ($6,366.04), card 67402 ($1,438.49), card 27453 ($971.53), card 47465 ($369.67), card 37452 ($226.71), card 27467 ($90.01)
  // Rows below sum to $648,182.08 vs FUEL_TOT $665,037.19 (gap $16,855.11).
  // Gap != the $23,484.83 unmapped-card total because frozen drivers
  // carry fixed historical fuel values rather than re-deriving from their cards.
  "Alexander Christopher": { fuel: 36074.0, gallons: 6065.32 },  // card 77409
  ...
  "Cowsky Andy": { fuel: 25811.14, gallons: 4374.45 },  // card 77457
  "Daniels Gerald W": { fuel: 17473.85, gallons: 3040.89 },  // card 47402 split (active, absorbs deltas over Christian)
  "Davis Anthoni D": { fuel: 54334.93, gallons: 9910.68 },  // card 27406
  "Denman Samuel E": { fuel: 32950.38, gallons: 6460.74 },  // cards 47405 + 37403
  "Dotch Brandon C": { fuel: 12032.86, gallons: 1880.68 },  // cards 07405 (Anderson-frozen split) + 17468 (UNCHANGED WoW × 3)
  "Gray Stephen D": { fuel: 9363.58, gallons: 1801.3 },  // NEW · card 27403
  "Gutierrez Danny": { fuel: 11229.36, gallons: 2290.16 },  // card 47404 (UNCHANGED WoW × 2)
  "Guzman Jose": { fuel: 14119.65, gallons: 2756.06 },  // card 77401 (UNCHANGED WoW)
  "Howell Lawrence": { fuel: 0.0, gallons: 0.0 },  
  "Ibarra Jose Pablo": { fuel: 10188.0, gallons: 1990.8 },  // card 97409
  ...
  "Lewis Steve": { fuel: 5285.56, gallons: 868.97 },  // NEW · card 97454
  ...
  "McNamara John": { fuel: 25243.55, gallons: 5243.82 },  // card 17407
  "Mcclam Michael A": { fuel: 29925.23, gallons: 4595.32 },  // card 07407
  "Memolo Dominick": { fuel: 0.0, gallons: 0.0 },  
  "Negrete Arturo": { fuel: 6348.68, gallons: 1511.56 },  // card 57404 (*inactive — frozen UNCHANGED)
  "Ponce Carlos": { fuel: 28116.1, gallons: 4844.17 },  // card 37466
  "Restrepo Julian E": { fuel: 30603.31, gallons: 5372.24 },  // card 37405 split (active, absorbs deltas over Wright+Clark)
  "Reyes Corey": { fuel: 17951.68, gallons: 2703.76 },  // cards 07469 + 97453
  "Robinson Animashaun": { fuel: 12257.27, gallons: 2225.21 },  // card 97455 ("Shaun R" on EFS = Animashaun/Robinson) — was unmapped, he had 968 hrs but $0 fuel
  "Ronkov Martin P": { fuel: 9557.67, gallons: 1878.24 },  // card 67403
  "Secrest Jermelle": { fuel: 16213.45, gallons: 2451.98 },  // cards 37404 + 27404 (Mell) — UNCHANGED WoW × 3
  "Stevenson Timothy": { fuel: 11858.32, gallons: 2120.08 },  // NEW · card 07452
  "Stringer Adam E": { fuel: 3165.51, gallons: 561.2 },  // card 77402 split (UNCHANGED WoW × 3 — Kelly portion frozen)
  "Striplin Lamareh": { fuel: 17268.96, gallons: 3211.49 },  // card 87407 — moved off UNCHANGED streak
  ...
  "Watson Dahnifu S": { fuel: 16703.74, gallons: 3044.54 },  // card 97406 (Shaq)
  "Whipple Wallace": { fuel: 34671.25, gallons: 6925.56 },  // card 57403
  "Williams Tadaryl C": { fuel: 24465.36, gallons: 4641.49 },  // card 37402 (UNCHANGED WoW × 2)
  "Williams Will": { fuel: 29231.66, gallons: 5073.85 },  // card 27405
  "Willis Wali A": { fuel: 16859.75, gallons: 3051.55 },  // card 87400
...
let TRAILER_TOT = 260395.28; // QuickBooks: Trailer Rentals (McKinney + Xtra + Utility + Premier + Boxwheel + Ten) thru Aug 9
let EQUIP_TOT   = TRUCK_TOT + TRAILER_TOT;
let TRUCK_MAINT  = 12902.56;  // Prime Wash, AutoForce, Titan Glass, Towing, Batteries, TZ Parts, eBay, SF Heavy Equipment thru Aug 9
let TRAIL_MAINT  = 10447.36;  // TravelCenters of America, MKD Express thru Aug 9
let STORAGE      = 70222.74;  // Storage/Parking per P&L thru Aug 9
...
let MONTHLY_MILES = [
  ...
  { m:"Apr", local:33547.5, regional:120323.8, total:153871.4,
    trucks:{"869":{l:135.1,r:9736.9,t:9872.0},"419":{l:1260.7,r:7943.0,t:9203.7},"502":{l:1226.1,r:7725.9,t:8952.0},"498":{l:1003.5,r:7936.9,t:8940.5},"496":{l:1041.3,r:7801.6,t:8843.0},"418":{l:1193.5,r:7560.3,t:8753.9},"353":{l:2785.9,r:5965.5,t:8751.5},"417":{l:1182.0,r:7348.3,t:8530.4},"402":{l:1067.8,r:5659.1,t:6726.9},"463":{l:603.0,r:5839.8,t:6442.8},"510":{l:669.7,r:5454.6,t:6124.3},"127":{l:783.7,r:4860.8,t:5644.6},"440":{l:2817.8,r:2481.2,t:5299.0},"951":{l:1830.3,r:3183.9,t:5014.2},"569":{l:2273.0,r:2609.8,t:4882.8},"508":{l:811.0,r:3889.6,t:4700.6},"574":{l:681.9,r:3770.6,t:4452.5},"570":{l:2862.7,r:1461.8,t:4324.6},"441":{l:1511.2,r:2798.0,t:4309.3},"568":{l:828.2,r:3222.9,t:4051.1},"577":{l:777.0,r:3211.8,t:3988.8},"120":{l:467.4,r:3513.4,t:3980.7},"020":{l:2915.5,r:489.4,t:3405.0},"573":{l:1773.4,r:1137.8,t:2911.3},"503":{l:350.4,r:2509.3,t:2859.7},"870":{l:294.4,r:2211.3,t:2505.7},"189":{l:400.8,r:0.0,t:400.8}} },
  { m:"May", local:23367.8, regional:121396.6, total:144764.4,
    trucks:{"508":{l:1165.0,r:8262.2,t:9427.2},"870":{l:1382.4,r:7894.8,t:9277.2},"496":{l:911.9,r:7967.4,t:8879.3},"402":{l:953.8,r:7741.9,t:8695.7},"869":{l:0.0,r:8481.6,t:8481.6},"419":{l:839.7,r:7202.5,t:8042.2},"417":{l:947.6,r:6516.9,t:7464.6},"498":{l:864.0,r:6591.1,t:7455.1},"502":{l:619.8,r:6501.5,t:7121.3},"441":{l:1889.4,r:4964.5,t:6853.9},"686":{l:0.0,r:6470.4,t:6470.4},"418":{l:959.0,r:5424.1,t:6383.1},"674":{l:0.0,r:6331.2,t:6331.2},"669":{l:0.0,r:5160.4,t:5160.4},"673":{l:0.0,r:5036.7,t:5036.7},"685":{l:0.0,r:5005.9,t:5005.9},"120":{l:551.9,r:4340.0,t:4891.9},"127":{l:502.8,r:3579.2,t:4082.0},"568":{l:420.1,r:2687.8,t:3107.9},"570":{l:2380.6,r:722.4,t:3103.0},"573":{l:1073.7,r:1210.1,t:2283.8},"020":{l:1922.9,r:0.0,t:1922.9},"569":{l:1918.4,r:0.0,t:1918.4},"510":{l:178.6,r:1717.8,t:1896.4},"440":{l:1861.1,r:0.0,t:1861.1},"574":{l:419.9,r:1074.8,t:1494.7},"951":{l:1120.3,r:0.0,t:1120.3},"577":{l:361.6,r:511.2,t:872.9},"189":{l:62.1,r:0.0,t:62.1},"353":{l:61.2,r:0.0,t:61.2}} },
  { m:"Jun", local:24844.1, regional:162205.9, total:187050.0,
    trucks:{"496":{l:1117.0,r:10562.9,t:11679.9},"402":{l:758.6,r:8923.6,t:9682.3},"419":{l:1050.4,r:8235.7,t:9286.1},"441":{l:2141.0,r:6862.9,t:9003.9},"685":{l:0.0,r:8970.5,t:8970.5},"674":{l:0.0,r:8826.9,t:8826.9},"502":{l:929.4,r:7825.7,t:8755.1},"508":{l:1187.9,r:7449.1,t:8637.0},"127":{l:1006.3,r:7544.9,t:8551.1},"418":{l:837.9,r:7599.7,t:8437.6},"120":{l:910.2,r:7408.5,t:8318.6},"510":{l:1432.4,r:6695.4,t:8127.8},"673":{l:0.0,r:7996.0,t:7996.0},"869":{l:217.8,r:7665.8,t:7883.6},"870":{l:449.1,r:7092.3,t:7541.5},"669":{l:0.0,r:7002.6,t:7002.6},"568":{l:899.4,r:5778.0,t:6677.5},"417":{l:672.0,r:5112.2,t:5784.3},"675":{l:206.1,r:5224.8,t:5430.9},"971":{l:1359.5,r:3928.6,t:5288.1},"573":{l:1813.1,r:3189.6,t:5002.7},"570":{l:2310.9,r:974.4,t:3285.2},"686":{l:0.0,r:2910.9,t:2910.9},"114":{l:43.6,r:2816.7,t:2860.3},"569":{l:1705.9,r:486.5,t:2192.4},"020":{l:1535.0,r:489.7,t:2024.7},"498":{l:141.9,r:1730.8,t:1872.7},"351":{l:628.1,r:730.1,t:1358.2},"440":{l:566.2,r:766.4,t:1332.6},"968":{l:97.3,r:1136.0,t:1233.3},"951":{l:586.4,r:0.0,t:586.4},"353":{l:240.8,r:236.8,t:477.6},"488":{l:0.0,r:31.8,t:31.8}} },
  { m:"Jul", local:28292.4, regional:175403.7, total:203696.1,
    trucks:{"510":{l:562.3,r:12801.7,t:13364.0},"419":{l:1875.2,r:8862.7,t:10737.9},"418":{l:1225.4,r:9159.8,t:10385.2},"674":{l:170.7,r:9772.3,t:9943.0},"869":{l:146.1,r:9796.6,t:9942.7},"498":{l:1312.9,r:7914.5,t:9227.4},"675":{l:340.4,r:8229.8,t:8570.1},"402":{l:1223.2,r:7046.6,t:8269.7},"685":{l:0.0,r:8141.2,t:8141.2},"870":{l:791.4,r:6822.0,t:7613.4},"508":{l:769.6,r:6721.3,t:7490.9},"496":{l:565.5,r:6705.0,t:7270.5},"502":{l:962.2,r:5896.2,t:6858.4},"673":{l:52.1,r:6741.7,t:6793.8},"120":{l:1920.6,r:4870.9,t:6791.5},"669":{l:0.0,r:6387.8,t:6387.8},"440":{l:1901.4,r:3891.6,t:5793.0},"569":{l:1826.6,r:3831.4,t:5658.0},"968":{l:0.0,r:5323.2,t:5323.2},"293":{l:1474.7,r:3180.7,t:4655.4},"417":{l:663.7,r:3873.4,t:4537.1},"568":{l:391.4,r:3910.5,t:4301.9},"488":{l:49.5,r:4238.5,t:4288.0},"573":{l:1199.5,r:2539.5,t:3739.0},"441":{l:1205.2,r:2514.8,t:3720.0},"951":{l:1403.4,r:2257.3,t:3660.7},"570":{l:1896.5,r:1586.9,t:3483.4},"292":{l:550.4,r:2897.1,t:3447.5},"074":{l:59.7,r:3249.8,t:3309.5},"020":{l:1497.9,r:744.6,t:2242.6},"114":{l:33.1,r:1974.6,t:2007.6},"316":{l:354.1,r:1428.6,t:1782.8},"353":{l:712.3,r:612.2,t:1324.5},"351":{l:939.1,r:0.0,t:939.1},"315":{l:75.5,r:598.3,t:673.8},"127":{l:141.0,r:489.7,t:630.7},"686":{l:0.0,r:390.8,t:390.8}} },
];
...
let MONTHLY_REVENUE = [
  ...
  { m:"Jul 26", ce:1457621.92, di:20648.70, sf:662668.54, total:2212835.07,  gp:1058654.05 },  // full July (total incl. CE East 71,895.91)
  { m:"Aug 26", ce:212277.50,  di:974.95,   sf:142462.50, total:362437.45,   gp:208200.16  },  // partial — Aug 1-10 only (total incl. CE East 6,722.50)
];
...
// ── INCOME DATA ───────────────────────────────────────────────
const INCOME_2026 = {
  period: "Jan 1 – Aug 9, 2026",
  ce: 10485833.71, sf: 4173862.75, di: 84852.15, ceEast: 548446.83,
  total: 15292995.44,
  cogs: 7996586.29, grossProfit: 7296409.15,
  totalExp: 6223698.80, netOpIncome: 1072710.35,
  netIncome: 587562.81,
  carrierPay: 7766947.94, merchantFees: 55079.60, flexentFees: 174558.75,
  weeks: [
    ...
    { label:"Jul 20-26",  rev:374314.27, gp:215168.19, ce:209461.00, sf:149948.57, di:1754.70,  carrier:157060.00, netInc:-23173.08 },  // netInc restated in the Aug-2 P&L (was -22,886.12)
    { label:"Jul 27-A2",  rev:501381.35, gp:211880.95, ce:330163.59, sf:133798.76, di:10044.00, carrier:258280.50, netInc:-88574.10 },
    { label:"Aug 3-9",    rev:362437.45, gp:208200.16, ce:212277.50, sf:142462.50, di:974.95,   carrier:152153.75, netInc:-3302.01 },
  ],
  months: [
    ...
    { m: "Jul", rev: 2212835.07, gp: 1058654.05, ce:1457621.92, sf:662668.54, di:20648.70, carrier:1115354.60, exp:1162677.29, netInc:-198247.64 },  // full July — LOSS month (June was +196,727.70). exp/netInc refreshed on the Aug-9 drop: $1,898.19 of late July expense posted after last week's pull.
    { m: "Aug", rev: 362437.45,  gp: 208200.16,  ce:212277.50,  sf:142462.50, di:974.95,   carrier:152153.75,  exp:208550.59,  netInc:-12692.16 },  // partial — Aug 1-10 only (all of it the Aug 3-9 week; Aug 1-2 and Aug 10 posted zero)
  ],
};
...
const OFFICE_W2 = [
  ...
  { name:"Adrian Arias",        entity:"SF",  gross: 53946.66, taxes: 5464.62, contrib: 2149.86, totalCost: 61561.14, salary: 52124.0,    bonus:1622.66, reimb:200.00,    commission:0.00,       note:"Salary + bonus" },
  { name:"Gabriel Gonzalez",    entity:"SF",  gross: 36484.83, taxes: 3924.33, contrib: 0.0,       totalCost: 40409.16, salary: 36203.83, bonus:250.00,     reimb:31.00,     commission:0.00,       note:"Salary + bonus" },
  ...
  { name:"Cecilia Rivera",      entity:"SF",  gross: 42710.0,    taxes: 4585.82, contrib: 1706.6, totalCost: 49002.42, salary: 41125.0,    bonus:1540.00,     reimb:45.00,     commission:0.00,       note:"Salary + bonus" },
  { name:"Nathan Youngblood",   entity:"SF",  gross: 37400.0,    taxes: 4025.1, contrib: 0.0,       totalCost: 41425.1, salary: 37400.0,    bonus:0.00,       reimb:0.00,      commission:0.00,       note:"Salary" },
  { name:"Tasha Mahan",         entity:"SF",  gross: 13000.0,     taxes: 1426.5,  contrib: 0.0,       totalCost: 14426.5,  salary: 13000.0,     bonus:0.00,       reimb:0.00,      commission:0.00,       note:"NEW · started Jun 2026 · office/warehouse" },
  { name:"Antionette Wilson",   entity:"SF",  gross: 8136.0,     taxes: 908.48,  contrib: 0.0,       totalCost: 9044.48,  salary: 8136.0,     bonus:0.00,       reimb:0.00,      commission:0.00,       note:"ATL office support (reclassified from driver Jul 2026)" },
  // J&A Management employees (thru ~Jul 2, 2026 YTD)
  { name:"Valeria Abrego",      entity:"J&A", gross: 25580.1, taxes: 2693.61, contrib: 0.0,       totalCost: 28273.71, salary: 25015.1, bonus:0.00,       reimb:565.00,    commission:0.00,       note:"Hourly + OT" },
  { name:"Christopher Adamson", entity:"J&A", gross: 54000.0,    taxes: 5462.15,    contrib: 2160.0,    totalCost: 61622.15,    salary: 54000.0,    bonus:0.00,       reimb:0.00,      commission:0.00,       note:"Salary + 401K" },
  ...
  { name:"Harold Galvis",       entity:"J&A", gross: 11390.0,     taxes: 1239.8,  contrib: 0.0,       totalCost: 12629.8,  salary: 11390.0,     bonus:0.00,       reimb:0.00,      commission:0.00,       note:"NEW · started Jun 2026" },
  { name:"Kidist Gelaw",        entity:"J&A", gross: 10170.0,     taxes: 1120.03,  contrib: 0.0,       totalCost: 11290.03,  salary: 10170.0,     bonus:0.00,       reimb:0.00,      commission:0.00,       note:"NEW · started Jun 2026" },
  ...
  { name:"Ben Hoffman",         entity:"J&A", gross: 42140.96, taxes: 4465.48, contrib: 376.95,  totalCost: 46983.39, salary: 41930.96, bonus:0.00,       reimb:210.00,     commission:0.00,       note:"Salary + 401K + PTO" },
  { name:"Joshua Law",         entity:"J&A", gross: 14562.91,  taxes: 1509.69,  contrib: 0.0,       totalCost: 16072.6,  salary: 14562.91,  bonus:0.00,       reimb:0.00,      commission:0.00,       note:"NEW · started Jun/Jul 2026" },
...
const WAREHOUSE = [
  { name:"Gentry Eagleton",  entity:"SF", gross: 27954.2, taxes: 2912.62, contrib: 0.0, totalCost: 30866.82, type:"Hourly", hours:1092.16, regHrs:1024.43, otHrs:67.73, note:"Regular + OT" },
  { name:"Andres Figueroa",  entity:"SF", gross: 48975.0, taxes: 5017.35, contrib: 0.0, totalCost: 53992.35, type:"Salary", hours:1080.00,    regHrs:0.00,      otHrs:0.00,     note:"Salary + PTO" },
];

// ATL designation tracked in ATL_WEEKLY_LOG (per-week roster).
// Mellody and ENM no longer tagged here.
const CONTRACTORS = [
  { name:"Jon Marcus Zengotita", dba:"", weekly:2800, payments:28, weeklyTotal:78400, car:350, carPayments:7, carTotal:2450, commission:0, healthIns:0, healthInsTotal:0, other:0, total:80850, note:"$2,800/wk + $350/mo car (7 months · July car paid 7/30; August car not yet paid as of Aug 9)" },
  { name:"Mellody Abrego",       dba:"Neon Vibes Enterprise", weekly:2250, payments:28, weeklyTotal:61200, car:334.86, carPayments:8, carTotal:3028.88, commission:5133.21, healthIns:368.34, healthInsTotal:10313.52, other:0, total:79675.61, note:"$2,250/wk + $334.86/mo car · August car paid this wk (carTotal = 5×334.86 + June 684.86 bump + July 334.86 + Aug 334.86 = 3,028.88) + commission YTD $5,133 (none this wk) + health ins $368.34/wk (28wk)" },
  { name:"Gabriel Colon",        dba:"", weekly:0, payments:27, weeklyTotal:61495.88, car:0, carPayments:0, carTotal:0, commission:0, healthIns:0, healthInsTotal:0, other:0, total:61495.88, note:"Variable weekly — +$3,000 this wk (split 50/50 CE/SF)" },
  { name:"Hilda Salman",         dba:"Salman Enterprises LLC", weekly:1730, payments:28, weeklyTotal:48440, car:0, carPayments:0, carTotal:0, commission:0, healthIns:118.82, healthInsTotal:3326.96, other:0, total:51766.96, note:"$1,730/wk + health ins $118.82/wk (28wk)" },
  { name:"Maria Con",            dba:"", weekly:650, payments:27, weeklyTotal:16550, car:0, carPayments:0, carTotal:0, commission:0, healthIns:0, healthInsTotal:0, other:0, total:16550, note:"$550/wk → $650/wk starting Mar 2026" },
  { name:"Logic Consultants",    dba:"Logic Consultants LLC / Prestige Development", weekly:500, payments:27, weeklyTotal:13500, car:0, carPayments:0, carTotal:0, commission:0, healthIns:0, healthInsTotal:0, other:0, total:13500, note:"$500/wk" },
  { name:"ENM Trucking",         dba:"ENM Trucking LLC (Biniyam Fissehaye)", weekly:1850, payments:10, weeklyTotal:18500, car:0, carPayments:0, carTotal:0, commission:0, healthIns:0, healthInsTotal:0, other:0, total:18500, note:"$1,850/wk · W2 (J&A) → 1099 May 11 2026 · ATL contractor (also in ATL_WEEKLY_LOG)" },
  { name:"Elizabeth Delgado",    dba:"", weekly:900, payments:21, weeklyTotal:18900, car:0, carPayments:0, carTotal:0, commission:3597.62, healthIns:0, healthInsTotal:0, other:480.57, total:22978.19, note:"$900/wk base + commission YTD $3,598 (none this wk) + reimb $131.99 (May 18-24) + $348.58 (Aug 3-9) · W2 → 1099 Feb 2026", dual:true },
  { name:"Christopher Simpson",  dba:"", weekly:834.97, payments:21, weeklyTotal:17959.52, car:0, carPayments:0, carTotal:0, commission:2551.20, healthIns:53.79, healthInsTotal:1506.12, other:562.50, total:22579.34, note:"~$835/wk base + commission YTD $2,551 (none this wk) + health ins $53.79/wk (28wk) + additional payments $270 (Jul 27-Aug 2) + $292.50 (Aug 3-9, per Ben NOT commission) · W2 → 1099 Feb 2026", dual:true },
...
const DRIVER_WEEKLY = {"weeks": ["1/2", "1/9", "1/16", "1/23", "1/30", "2/6", "2/13", "2/20", "2/27", "3/6", "3/13", "3/20", "3/27", "4/3", "4/10", "4/17", "4/24", "5/1", "5/8", "5/15", "5/22", "5/29", "6/5", "6/12", "6/18", "6/26", "7/2", "7/10", "7/17", "7/24", "7/31", "8/7"], "fleet": {"8/7": 46206.07, "7/31": 50723.57, "7/24": 41247.59, "7/17": 46052.3, "7/10": 41485.71, "7/2": 42519.11, "6/26": 50445.7, "6/18": 43899.68, "6/12": 58775.47, "6/5": 49103.14, "5/29": 49237.73, "5/22": 51403.42, "5/15": 50315.18, "5/8": 49541.42, "5/1": 49488.23, "4/24": 51000.0, "4/17": 46616.13, "4/10": 39337.61, "4/3": 37045.97, "3/27": 45643.79, "3/20": 51687.84, "3/13": 42120.91, "3/6": 41650.27, "2/27": 28986.1, "2/20": 30436.69, "2/13": 29959.35, "2/6": 29102.85, "1/30": 30542.41, "1/23": 33809.27, "1/16": 33847.64, "1/9": 22532.31, "1/2": 16449.89}, "otr": {"8/7": 16818.69, "7/31": 17259.2, "7/24": 14830.12, "7/17": 15634.97, "7/10": 14701.11, "7/2": 14630.91, "6/26": 16669.81, "6/18": 10073.33, "6/12": 8669.52, "6/5": 7387.95, "5/29": 6839.82, "5/22": 6432.03, "5/15": 2281.83, "5/8": 1982.58, "5/1": 1929.18, "4/24": 2485.25, "4/17": 1582.32, "4/10": 2060.66, "4/3": 1617.12, "3/27": 1746.71, "3/20": 2492.34, "3/13": 1574.63, "3/6": 2212.64, "2/27": 2043.24, "2/20": 1955.46, "2/13": 2087.68, "2/6": 1834.55, "1/30": 1981.13, "1/23": 1570.11, "1/16": 1292.41}};

const OFFICE_PAYCHECKS = {"source": "W-2 paychecks (loaded) + contractors NET cash (car/health/commission in dropdown) \u00b7 32 weeks \u00b7 columns = pay day \u00b7 accumulated (never overwrites prior weeks)", "weeks": ["1/2", "1/9", "1/16", "1/23", "1/30", "2/6", "2/13", "2/20", "2/27", "3/6", "3/13", "3/20", "3/27", "4/3", "4/10", "4/17", "4/24", "5/1", "5/8", "5/15", "5/22", "5/29", "6/5", "6/12", "6/18", "6/26", "7/2", "7/10", "7/17", "7/24", "7/31", "8/7"], "sections": [{"name": "CE", "rows": [{"name": "Galvis, Harold A (50%)", "former": false, "amts": {"6/5": 627.15, "6/12": 627.15, "6/18": 627.15, "6/26": 627.15, "7/2": 627.15, "7/10": 627.15, "7/17": 677.1, "7/24": 627.15, "7/31": 627.15, "8/7": 627.15}, "camts": {}, "net": {"6/5": 439.93, "6/12": 439.93, "6/18": 439.93, "6/26": 439.93, "7/2": 439.93, "7/10": 439.93, "7/17": 484.93, "7/24": 439.93, "7/31": 439.93, "8/7": 439.93}, "gross": {"6/5": 565.0, "6/12": 565.0, "6/18": 565.0, "6/26": 565.0, "7/2": 565.0, "7/10": 565.0, "7/17": 610.0, "7/24": 565.0, "7/31": 565.0, "8/7": 565.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 6321.45}, {"name": "Gelaw, Kidist B (50%)", "former": false, "amts": {"6/12": 627.15, "6/18": 627.15, "6/26": 627.15, "7/2": 627.15, "7/10": 627.15, "7/17": 627.15, "7/24": 627.15, "7/31": 627.15, "8/7": 627.15}, "camts": {}, "net": {"6/12": 474.94, "6/18": 474.94, "6/26": 474.94, "7/2": 474.94, "7/10": 474.94, "7/17": 474.94, "7/24": 474.94, "7/31": 474.94, "8/7": 474.94}, "gross": {"6/12": 565.0, "6/18": 565.0, "6/26": 565.0, "7/2": 565.0, "7/10": 565.0, "7/17": 565.0, "7/24": 565.0, "7/31": 565.0, "8/7": 565.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 5644.35}, {"name": "Rivera, Cecilia I", "former": false, "amts": {"1/9": 1426.35, "1/16": 1426.35, "1/23": 1426.35, "1/30": 1426.35, "2/6": 1426.35, "2/13": 1426.35, "2/20": 1665.0, "2/27": 1665.0, "3/6": 1426.35, "3/13": 1426.35, "3/20": 1426.35, "3/27": 1426.35, "4/3": 1426.35, "4/10": 1665.0, "4/17": 1426.35, "4/24": 1426.35, "5/1": 1426.35, "5/8": 1665.0, "5/15": 1426.35, "5/22": 1426.35, "5/29": 1443.0, "6/5": 1443.0, "6/12": 1720.5, "6/18": 1665.0, "6/26": 1665.0, "7/2": 1665.0, "7/10": 1665.0, "7/17": 1665.0, "7/24": 1665.0, "7/31": 1665.0, "8/7": 1665.0}, "camts": {}, "net": {"1/9": 1135.3, "1/16": 1135.29, "1/23": 1135.3, "1/30": 1135.3, "2/6": 1135.3, "2/13": 1135.29, "2/20": 1325.25, "2/27": 1325.25, "3/6": 1135.3, "3/13": 1135.3, "3/20": 1135.3, "3/27": 1135.29, "4/3": 1135.3, "4/10": 1325.25, "4/17": 1135.3, "4/24": 1135.3, "5/1": 1135.29, "5/8": 1325.25, "5/15": 1135.3, "5/22": 1135.3, "5/29": 1150.3, "6/5": 1150.29, "6/12": 1371.18, "6/18": 1325.25, "6/26": 1325.25, "7/2": 1325.25, "7/10": 1325.25, "7/17": 1325.25, "7/24": 1325.25, "7/31": 1325.25, "8/7": 1325.25}, "gross": {"1/9": 1285.0, "1/16": 1285.0, "1/23": 1285.0, "1/30": 1285.0, "2/6": 1285.0, "2/13": 1285.0, "2/20": 1500.0, "2/27": 1500.0, "3/6": 1285.0, "3/13": 1285.0, "3/20": 1285.0, "3/27": 1285.0, "4/3": 1285.0, "4/10": 1500.0, "4/17": 1285.0, "4/24": 1285.0, "5/1": 1285.0, "5/8": 1500.0, "5/15": 1285.0, "5/22": 1285.0, "5/29": 1300.0, "6/5": 1300.0, "6/12": 1550.0, "6/18": 1500.0, "6/26": 1500.0, "7/2": 1500.0, "7/10": 1500.0, "7/17": 1500.0, "7/24": 1500.0, "7/31": 1500.0, "8/7": 1500.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 47408.1}, {"name": "Youngblood, Nathan", "former": false, "amts": {"1/9": 1332.0, "1/16": 1332.0, "1/23": 1332.0, "1/30": 1332.0, "2/6": 1332.0, "2/13": 1332.0, "2/20": 1332.0, "2/27": 1332.0, "3/6": 1332.0, "3/13": 1332.0, "3/20": 1332.0, "3/27": 1332.0, "4/3": 1332.0, "4/10": 1332.0, "4/17": 1332.0, "4/24": 1332.0, "5/1": 1332.0, "5/8": 1332.0, "5/15": 1332.0, "5/22": 1332.0, "5/29": 1332.0, "6/5": 1332.0, "6/12": 1332.0, "6/18": 1332.0, "6/26": 1332.0, "7/2": 1332.0, "7/10": 1332.0, "7/17": 1332.0, "7/24": 1332.0, "7/31": 1443.0, "8/7": 1443.0}, "camts": {}, "net": {"1/9": 815.97, "1/16": 815.97, "1/23": 815.97, "1/30": 815.97, "2/6": 815.97, "2/13": 815.97, "2/20": 815.97, "2/27": 815.97, "3/6": 815.97, "3/13": 815.97, "3/20": 815.97, "3/27": 815.97, "4/3": 815.97, "4/10": 815.97, "4/17": 815.97, "4/24": 815.97, "5/1": 815.97, "5/8": 815.97, "5/15": 815.97, "5/22": 815.97, "5/29": 815.97, "6/5": 815.97, "6/12": 815.97, "6/18": 815.97, "6/26": 815.97, "7/2": 815.97, "7/10": 815.97, "7/17": 815.97, "7/24": 815.97, "7/31": 894.21, "8/7": 894.21}, "gross": {"1/9": 1200.0, "1/16": 1200.0, "1/23": 1200.0, "1/30": 1200.0, "2/6": 1200.0, "2/13": 1200.0, "2/20": 1200.0, "2/27": 1200.0, "3/6": 1200.0, "3/13": 1200.0, "3/20": 1200.0, "3/27": 1200.0, "4/3": 1200.0, "4/10": 1200.0, "4/17": 1200.0, "4/24": 1200.0, "5/1": 1200.0, "5/8": 1200.0, "5/15": 1200.0, "5/22": 1200.0, "5/29": 1200.0, "6/5": 1200.0, "6/12": 1200.0, "6/18": 1200.0, "6/26": 1200.0, "7/2": 1200.0, "7/10": 1200.0, "7/17": 1200.0, "7/24": 1200.0, "7/31": 1300.0, "8/7": 1300.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 41514.0}, {"name": "Gabriel Colon \u00b7 1099 (50%)", "former": false, "amts": {}, "camts": {"1/9": 1000.0, "1/16": 1212.81, "1/23": 1000.0, "1/30": 1000.0, "2/6": 1174.98, "2/13": 1220.31, "2/20": 1177.48, "2/27": 1184.14, "3/6": 1178.82, "3/13": 1000.0, "3/20": 1125.82, "3/27": 1099.99, "4/3": 1416.65, "4/10": 1250.0, "4/17": 1000.0, "4/24": 1123.82, "5/1": 1105.32, "5/8": 1000.0, "5/15": 1165.82, "5/22": 1000.0, "5/29": 1000.0, "6/5": 1066.66, "6/12": 1100.0, "6/18": 1000.0, "6/26": 1145.32, "7/2": 1000.0, "7/10": 1174.15, "7/24": 1500.0, "7/31": 1500.0, "8/7": 1500.0}, "net": {}, "gross": {}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 34422.09}, {"name": "Jon Marcus \u00b7 1099", "former": false, "amts": {}, "camts": {"1/9": 2800.0, "1/16": 2800.0, "1/23": 2800.0, "1/30": 3150.0, "2/6": 2800.0, "2/13": 2800.0, "2/20": 2800.0, "2/27": 3150.0, "3/6": 2800.0, "3/13": 2800.0, "3/20": 2800.0, "3/27": 2800.0, "4/3": 350.0, "4/10": 2800.0, "4/17": 2800.0, "4/24": 2800.0, "5/1": 350.0, "5/8": 2800.0, "5/15": 2800.0, "5/22": 2800.0, "5/29": 350.0, "6/5": 2800.0, "6/12": 2800.0, "6/18": 2800.0, "6/26": 2800.0, "7/2": 2800.0, "7/10": 2800.0, "7/17": 2800.0, "7/24": 2800.0, "7/31": 2800.0, "8/7": 2800.0}, "net": {}, "gross": {}, "car": {"1/9": 350.0, "2/6": 350.0, "3/6": 350.0, "4/10": 350.0, "5/8": 350.0, "7/2": 350.0, "7/31": 350.0}, "health": {}, "commission": {}, "reimb": {}, "total": 82600.0}, {"name": "Mairena Tapias \u00b7 1099", "former": false, "amts": {}, "camts": {"4/24": 193.04, "5/8": 900.0, "5/22": 882.0, "5/29": 695.0, "6/5": 140.0, "6/12": 950.0, "6/18": 475.0, "6/26": 475.0, "7/2": 956.0, "7/10": 478.0, "7/17": 478.0, "7/24": 478.0, "7/31": 478.0, "8/7": 478.0}, "net": {}, "gross": {}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 8056.04}, {"name": "Naruszewicz, Bartosz (50%)", "former": true, "amts": {"5/8": 979.19, "5/15": 991.17, "5/22": 1165.5, "5/29": 999.0, "6/5": 999.0, "6/12": 999.0, "6/18": 1064.43, "6/26": 1042.96, "7/2": 999.0, "7/10": 832.5}, "camts": {}, "net": {"5/8": 705.5, "5/15": 713.1, "5/22": 823.58, "5/29": 718.05, "6/5": 718.05, "6/12": 718.05, "6/18": 759.52, "6/26": 745.91, "7/2": 718.05, "7/10": 612.53}, "gross": {"5/8": 882.15, "5/15": 892.95, "5/22": 1050.0, "5/29": 900.0, "6/5": 900.0, "6/12": 900.0, "6/18": 958.95, "6/26": 939.6, "7/2": 900.0, "7/10": 750.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 10071.75}], "totals": {"1/9": 2758.35, "1/16": 2758.35, "1/23": 2758.35, "1/30": 2758.35, "2/6": 2758.35, "2/13": 2758.35, "2/20": 2997.0, "2/27": 2997.0, "3/6": 2758.35, "3/13": 2758.35, "3/20": 2758.35, "3/27": 2758.35, "4/3": 2758.35, "4/10": 2997.0, "4/17": 2758.35, "4/24": 2758.35, "5/1": 2758.35, "5/8": 3976.19, "5/15": 3749.52, "5/22": 3923.85, "5/29": 3774.0, "6/5": 4401.15, "6/12": 5305.8, "6/18": 5315.73, "6/26": 5294.26, "7/2": 5250.3, "7/10": 5083.8, "7/17": 4301.25, "7/24": 4251.3, "7/31": 4362.3, "8/7": 4362.3}, "ctotals": {"1/9": 3800.0, "1/16": 4012.81, "1/23": 3800.0, "1/30": 4150.0, "2/6": 3974.98, "2/13": 4020.31, "2/20": 3977.48, "2/27": 4334.14, "3/6": 3978.82, "3/13": 3800.0, "3/20": 3925.82, "3/27": 3899.99, "4/3": 1766.65, "4/10": 4050.0, "4/17": 3800.0, "4/24": 4116.86, "5/1": 1455.32, "5/8": 4700.0, "5/15": 3965.82, "5/22": 4682.0, "5/29": 2045.0, "6/5": 4006.66, "6/12": 4850.0, "6/18": 4275.0, "6/26": 4420.32, "7/2": 4756.0, "7/10": 4452.15, "7/17": 3278.0, "7/24": 4778.0, "7/31": 4778.0, "8/7": 4778.0}, "ltotals": {"1/9": 4150.0, "1/16": 4012.81, "1/23": 3800.0, "1/30": 4150.0, "2/6": 4324.98, "2/13": 4020.31, "2/20": 3977.48, "2/27": 4334.14, "3/6": 4328.82, "3/13": 3800.0, "3/20": 3925.82, "3/27": 3899.99, "4/3": 1766.65, "4/10": 4400.0, "4/17": 3800.0, "4/24": 4116.86, "5/1": 1455.32, "5/8": 5050.0, "5/15": 3965.82, "5/22": 4682.0, "5/29": 2045.0, "6/5": 4006.66, "6/12": 4850.0, "6/18": 4275.0, "6/26": 4420.32, "7/2": 5106.0, "7/10": 4452.15, "7/17": 3278.0, "7/24": 4778.0, "7/31": 5128.0, "8/7": 4778.0}, "rtotals": {}}, {"name": "SF", "rows": [{"name": "Arias, Adrian", "former": false, "amts": {"1/9": 1827.06, "1/16": 2131.57, "1/23": 2131.57, "1/30": 1827.06, "2/6": 1827.06, "2/13": 1827.06, "2/20": 1827.06, "2/27": 1827.06, "3/6": 1827.06, "3/13": 1827.06, "3/20": 2631.81, "3/27": 1827.06, "4/3": 1827.06, "4/10": 1827.06, "4/17": 1827.06, "4/24": 1827.06, "5/1": 2131.2, "5/8": 1827.06, "5/15": 1827.06, "5/22": 1827.06, "5/29": 1827.06, "6/5": 1827.06, "6/12": 1827.06, "6/18": 1827.06, "6/26": 2132.31, "7/2": 1827.06, "7/10": 1827.06, "7/17": 2132.31, "7/24": 1827.06, "7/31": 1827.06, "8/7": 2740.59}, "camts": {}, "net": {"1/9": 1423.28, "1/16": 1625.86, "1/23": 1625.85, "1/30": 1423.29, "2/6": 1423.27, "2/13": 1173.28, "2/20": 1173.29, "2/27": 1173.28, "3/6": 1173.28, "3/13": 1173.27, "3/20": 1994.38, "3/27": 1423.29, "4/3": 1423.28, "4/10": 1423.28, "4/17": 1423.28, "4/24": 1423.28, "5/1": 1625.63, "5/8": 1423.28, "5/15": 1423.29, "5/22": 1423.28, "5/29": 1423.27, "6/5": 1423.28, "6/12": 1423.29, "6/18": 1423.28, "6/26": 1626.31, "7/2": 1423.27, "7/10": 1423.28, "7/17": 1626.31, "7/24": 1423.28, "7/31": 1423.28, "8/7": 2131.14}, "gross": {"1/9": 1646.0, "1/16": 1920.33, "1/23": 1920.33, "1/30": 1646.0, "2/6": 1646.0, "2/13": 1646.0, "2/20": 1646.0, "2/27": 1646.0, "3/6": 1646.0, "3/13": 1646.0, "3/20": 2371.0, "3/27": 1646.0, "4/3": 1646.0, "4/10": 1646.0, "4/17": 1646.0, "4/24": 1646.0, "5/1": 1920.0, "5/8": 1646.0, "5/15": 1646.0, "5/22": 1646.0, "5/29": 1646.0, "6/5": 1646.0, "6/12": 1646.0, "6/18": 1646.0, "6/26": 1921.0, "7/2": 1646.0, "7/10": 1646.0, "7/17": 1921.0, "7/24": 1646.0, "7/31": 1646.0, "8/7": 2469.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 59880.8}, {"name": "Eagleton, Gentry J", "former": false, "amts": {"1/9": 893.66, "1/16": 1275.95, "1/23": 923.63, "1/30": 968.25, "2/6": 734.6, "2/13": 903.54, "2/20": 893.77, "2/27": 877.9, "3/6": 907.54, "3/13": 1016.87, "3/20": 900.88, "3/27": 934.07, "4/3": 1018.43, "4/10": 1063.49, "4/17": 977.91, "4/24": 949.27, "5/1": 949.27, "5/8": 945.94, "5/15": 891.0, "5/22": 958.6, "5/29": 1005.22, "6/5": 912.98, "6/12": 1025.86, "6/18": 932.29, "6/26": 1174.05, "7/2": 1073.81, "7/10": 1052.39, "7/17": 888.0, "7/24": 923.63, "7/31": 2035.19, "8/7": 1021.2}, "camts": {}, "net": {"1/9": 688.82, "1/16": 965.54, "1/23": 710.51, "1/30": 742.82, "2/6": 573.69, "2/13": 695.97, "2/20": 688.9, "2/27": 677.41, "3/6": 698.87, "3/13": 778.0, "3/20": 694.06, "3/27": 718.05, "4/3": 779.14, "4/10": 811.76, "4/17": 749.79, "4/24": 729.08, "5/1": 729.08, "5/8": 726.66, "5/15": 686.9, "5/22": 735.82, "5/29": 789.22, "6/5": 702.81, "6/12": 784.52, "6/18": 716.79, "6/26": 891.78, "7/2": 819.23, "7/10": 803.73, "7/17": 684.72, "7/24": 710.51, "7/31": 1691.98, "8/7": 531.14}, "gross": {"1/9": 805.1, "1/16": 1149.5, "1/23": 832.1, "1/30": 872.3, "2/6": 661.8, "2/13": 814.0, "2/20": 805.2, "2/27": 790.9, "3/6": 817.6, "3/13": 916.1, "3/20": 811.6, "3/27": 841.5, "4/3": 917.5, "4/10": 958.1, "4/17": 881.0, "4/24": 855.2, "5/1": 855.2, "5/8": 852.2, "5/15": 802.7, "5/22": 863.6, "5/29": 905.6, "6/5": 822.5, "6/12": 924.2, "6/18": 839.9, "6/26": 1057.7, "7/2": 967.4, "7/10": 948.1, "7/17": 800.0, "7/24": 832.1, "7/31": 1833.5, "8/7": 920.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 31029.19}, {"name": "Figueroa, Andres", "former": false, "amts": {"1/2": 1581.75, "1/9": 1748.25, "1/16": 1581.75, "1/23": 1748.25, "1/30": 1581.75, "2/6": 1581.75, "2/13": 1581.75, "2/20": 1581.75, "2/27": 1581.75, "3/6": 1581.75, "3/13": 1581.75, "3/20": 1581.75, "3/27": 1581.75, "4/3": 1581.75, "4/10": 1581.75, "4/17": 1581.75, "4/24": 1581.75, "5/1": 1581.75, "5/8": 1581.75, "5/15": 1581.75, "5/22": 1581.75, "5/29": 1956.38, "6/5": 1845.38, "6/12": 1845.38, "6/18": 1803.75, "6/26": 1845.38, "7/2": 1845.38, "7/10": 1845.38, "7/17": 1845.38, "7/24": 1845.38, "7/31": 2067.38, "8/7": 2067.38}, "camts": {}, "net": {"1/2": 1315.99, "1/9": 1465.98, "1/16": 1315.99, "1/23": 1465.99, "1/30": 1315.99, "2/6": 1315.98, "2/13": 1315.99, "2/20": 1315.99, "2/27": 1315.99, "3/6": 1315.98, "3/13": 1315.99, "3/20": 1315.99, "3/27": 1315.99, "4/3": 1315.98, "4/10": 1315.99, "4/17": 1315.99, "4/24": 1315.99, "5/1": 1315.98, "5/8": 1315.99, "5/15": 1315.99, "5/22": 1315.99, "5/29": 1635.31, "6/5": 1535.32, "6/12": 1535.32, "6/18": 1515.99, "6/26": 1535.32, "7/2": 1535.31, "7/10": 1553.49, "7/17": 1535.32, "7/24": 1553.49, "7/31": 1720.02, "8/7": 1720.02}, "gross": {"1/2": 1425.0, "1/9": 1575.0, "1/16": 1425.0, "1/23": 1575.0, "1/30": 1425.0, "2/6": 1425.0, "2/13": 1425.0, "2/20": 1425.0, "2/27": 1425.0, "3/6": 1425.0, "3/13": 1425.0, "3/20": 1425.0, "3/27": 1425.0, "4/3": 1425.0, "4/10": 1425.0, "4/17": 1425.0, "4/24": 1425.0, "5/1": 1425.0, "5/8": 1425.0, "5/15": 1425.0, "5/22": 1425.0, "5/29": 1762.5, "6/5": 1662.5, "6/12": 1662.5, "6/18": 1625.0, "6/26": 1662.5, "7/2": 1662.5, "7/10": 1662.5, "7/17": 1662.5, "7/24": 1662.5, "7/31": 1862.5, "8/7": 1862.5}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 54362.3}, {"name": "Gonzalez, Gabriel", "former": false, "amts": {"1/9": 1174.04, "1/16": 1174.04, "1/23": 1451.54, "1/30": 1174.04, "2/6": 1174.04, "2/13": 1174.04, "2/20": 1174.04, "2/27": 1332.0, "3/6": 1332.0, "3/13": 1332.0, "3/20": 1332.0, "3/27": 1332.0, "4/3": 1332.0, "4/10": 1332.0, "4/17": 1332.0, "4/24": 1366.41, "5/1": 1332.0, "5/8": 1332.0, "5/15": 1332.0, "5/22": 1332.0, "5/29": 1332.0, "6/5": 1332.0, "6/12": 1332.0, "6/18": 1332.0, "6/26": 1332.0, "7/2": 1332.0, "7/10": 1332.0, "7/17": 1332.0, "7/24": 1332.0, "7/31": 1332.0, "8/7": 1332.0}, "camts": {}, "net": {"1/9": 891.77, "1/16": 891.79, "1/23": 1089.77, "1/30": 891.77, "2/6": 891.78, "2/13": 891.78, "2/20": 891.77, "2/27": 1006.12, "3/6": 1006.12, "3/13": 1006.12, "3/20": 1006.12, "3/27": 1006.12, "4/3": 1006.12, "4/10": 1006.12, "4/17": 1006.12, "4/24": 1037.12, "5/1": 1006.12, "5/8": 1006.12, "5/15": 1006.12, "5/22": 1006.12, "5/29": 1006.12, "6/5": 1006.12, "6/12": 1006.12, "6/18": 1006.12, "6/26": 1006.12, "7/2": 1006.12, "7/10": 1006.12, "7/17": 1006.12, "7/24": 1006.12, "7/31": 1006.12, "8/7": 1006.12}, "gross": {"1/9": 1057.69, "1/16": 1057.69, "1/23": 1307.69, "1/30": 1057.69, "2/6": 1057.69, "2/13": 1057.69, "2/20": 1057.69, "2/27": 1200.0, "3/6": 1200.0, "3/13": 1200.0, "3/20": 1200.0, "3/27": 1200.0, "4/3": 1200.0, "4/10": 1200.0, "4/17": 1200.0, "4/24": 1231.0, "5/1": 1200.0, "5/8": 1200.0, "5/15": 1200.0, "5/22": 1200.0, "5/29": 1200.0, "6/5": 1200.0, "6/12": 1200.0, "6/18": 1200.0, "6/26": 1200.0, "7/2": 1200.0, "7/10": 1200.0, "7/17": 1200.0, "7/24": 1200.0, "7/31": 1200.0, "8/7": 1200.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 40498.19}, {"name": "Mahan, Tasha", "former": false, "amts": {"6/5": 1443.0, "6/12": 1443.0, "6/18": 1443.0, "6/26": 1443.0, "7/2": 1443.0, "7/10": 1443.0, "7/17": 1443.0, "7/24": 1443.0, "7/31": 1443.0, "8/7": 1443.0}, "camts": {}, "net": {"6/5": 1093.97, "6/12": 1093.97, "6/18": 1093.97, "6/26": 1093.97, "7/2": 1093.97, "7/10": 1093.97, "7/17": 1093.97, "7/24": 1093.97, "7/31": 1093.97, "8/7": 1093.97}, "gross": {"6/5": 1300.0, "6/12": 1300.0, "6/18": 1300.0, "6/26": 1300.0, "7/2": 1300.0, "7/10": 1300.0, "7/17": 1300.0, "7/24": 1300.0, "7/31": 1300.0, "8/7": 1300.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 14430.0}, {"name": "Wilson, Antionette", "former": false, "amts": {"6/26": 1254.3, "7/2": 1254.3, "7/10": 1254.3, "7/17": 1505.16, "7/24": 1254.3, "7/31": 1254.3, "8/7": 1254.3}, "camts": {}, "net": {"6/26": 949.87, "7/2": 949.88, "7/10": 949.87, "7/17": 1158.59, "7/24": 949.88, "7/31": 949.87, "8/7": 949.88}, "gross": {"6/26": 1130.0, "7/2": 1130.0, "7/10": 1130.0, "7/17": 1356.0, "7/24": 1130.0, "7/31": 1130.0, "8/7": 1130.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 9030.96}, {"name": "Gabriel Colon \u00b7 1099 (50%)", "former": false, "amts": {}, "camts": {"1/9": 1000.0, "1/16": 1212.81, "1/23": 1000.0, "1/30": 1000.0, "2/6": 1174.98, "2/13": 1220.31, "2/20": 1177.48, "2/27": 1184.14, "3/6": 1178.82, "3/13": 1000.0, "3/20": 1125.82, "3/27": 1099.99, "4/3": 1416.65, "4/10": 1250.0, "4/17": 1000.0, "4/24": 1123.82, "5/1": 1105.32, "5/8": 1000.0, "5/15": 1165.82, "5/22": 1000.0, "5/29": 1000.0, "6/5": 1066.66, "6/12": 1100.0, "6/18": 1000.0, "6/26": 1145.32, "7/2": 1000.0, "7/10": 1174.14, "7/24": 1500.0, "7/31": 1500.0, "8/7": 1500.0}, "net": {}, "gross": {}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 34422.08}, {"name": "Maria Con \u00b7 1099", "former": false, "amts": {}, "camts": {"1/9": 550.0, "1/16": 550.0, "1/23": 550.0, "1/30": 550.0, "2/6": 550.0, "2/13": 550.0, "2/20": 550.0, "2/27": 550.0, "3/6": 550.0, "3/13": 550.0, "3/20": 650.0, "3/27": 650.0, "4/3": 650.0, "4/10": 650.0, "4/17": 650.0, "4/24": 650.0, "5/1": 650.0, "5/8": 650.0, "5/15": 650.0, "5/22": 650.0, "5/29": 650.0, "6/5": 650.0, "6/12": 650.0, "6/18": 650.0, "6/26": 650.0, "7/2": 650.0, "7/10": 650.0, "7/17": 650.0, "7/24": 650.0, "7/31": 650.0, "8/7": 650.0}, "net": {}, "gross": {}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 19150.0}, {"name": "Grosser, Scot E", "former": true, "amts": {"1/9": 1856.26, "1/16": 1856.26, "1/23": 1856.26, "1/30": 1856.26, "2/6": 1856.26, "2/13": 1856.26, "2/20": 1856.26, "2/27": 1856.26, "3/6": 1856.26, "3/13": 1856.26, "3/20": 1856.26, "3/27": 1856.26, "4/3": 2115.26, "4/10": 1856.26, "4/17": 1856.26, "4/24": 1856.26, "5/1": 1856.26, "5/8": 2114.89, "5/15": 1930.73, "5/22": 2072.37}, "camts": {}, "net": {"1/9": 1125.45, "1/16": 1125.46, "1/23": 1125.45, "1/30": 1125.44, "2/6": 1125.46, "2/13": 1125.45, "2/20": 1125.45, "2/27": 1125.46, "3/6": 1125.45, "3/13": 1125.44, "3/20": 1125.46, "3/27": 1125.45, "4/3": 1303.05, "4/10": 1125.45, "4/17": 1125.44, "4/24": 1125.46, "5/1": 1125.45, "5/8": 1302.82, "5/15": 1192.54, "5/22": 1424.99}, "gross": {"1/9": 1672.31, "1/16": 1672.31, "1/23": 1672.31, "1/30": 1672.31, "2/6": 1672.31, "2/13": 1672.31, "2/20": 1672.31, "2/27": 1672.31, "3/6": 1672.31, "3/13": 1672.31, "3/20": 1672.31, "3/27": 1672.31, "4/3": 1905.64, "4/10": 1672.31, "4/17": 1672.31, "4/24": 1672.31, "5/1": 1672.31, "5/8": 1905.31, "5/15": 1739.4, "5/22": 1867.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 37933.41}, {"name": "Naruszewicz, Bartosz (50%)", "former": true, "amts": {"5/8": 979.19, "5/15": 991.17, "5/22": 1165.5, "5/29": 999.0, "6/5": 999.0, "6/12": 999.0, "6/18": 1064.43, "6/26": 1042.96, "7/2": 999.0, "7/10": 832.5}, "camts": {}, "net": {"5/8": 705.5, "5/15": 713.1, "5/22": 823.58, "5/29": 718.05, "6/5": 718.05, "6/12": 718.05, "6/18": 759.52, "6/26": 745.91, "7/2": 718.05, "7/10": 612.53}, "gross": {"5/8": 882.15, "5/15": 892.95, "5/22": 1050.0, "5/29": 900.0, "6/5": 900.0, "6/12": 900.0, "6/18": 958.95, "6/26": 939.6, "7/2": 900.0, "7/10": 750.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 10071.75}], "totals": {"1/2": 1581.75, "1/9": 7499.27, "1/16": 8019.57, "1/23": 8111.25, "1/30": 7407.36, "2/6": 7173.71, "2/13": 7342.65, "2/20": 7332.88, "2/27": 7474.97, "3/6": 7504.61, "3/13": 7613.94, "3/20": 8302.7, "3/27": 7531.14, "4/3": 7874.5, "4/10": 7660.56, "4/17": 7574.98, "4/24": 7580.75, "5/1": 7850.48, "5/8": 8780.83, "5/15": 8553.71, "5/22": 8937.28, "5/29": 7119.66, "6/5": 8359.42, "6/12": 8472.3, "6/18": 8402.53, "6/26": 10224.0, "7/2": 9774.55, "7/10": 9586.63, "7/17": 9145.85, "7/24": 8625.37, "7/31": 9958.93, "8/7": 9858.47}, "ctotals": {"1/9": 1550.0, "1/16": 1762.81, "1/23": 1550.0, "1/30": 1550.0, "2/6": 1724.98, "2/13": 1770.31, "2/20": 1727.48, "2/27": 1734.14, "3/6": 1728.82, "3/13": 1550.0, "3/20": 1775.82, "3/27": 1749.99, "4/3": 2066.65, "4/10": 1900.0, "4/17": 1650.0, "4/24": 1773.82, "5/1": 1755.32, "5/8": 1650.0, "5/15": 1815.82, "5/22": 1650.0, "5/29": 1650.0, "6/5": 1716.66, "6/12": 1750.0, "6/18": 1650.0, "6/26": 1795.32, "7/2": 1650.0, "7/10": 1824.14, "7/17": 650.0, "7/24": 2150.0, "7/31": 2150.0, "8/7": 2150.0}, "ltotals": {"1/9": 1550.0, "1/16": 1762.81, "1/23": 1550.0, "1/30": 1550.0, "2/6": 1724.98, "2/13": 1770.31, "2/20": 1727.48, "2/27": 1734.14, "3/6": 1728.82, "3/13": 1550.0, "3/20": 1775.82, "3/27": 1749.99, "4/3": 2066.65, "4/10": 1900.0, "4/17": 1650.0, "4/24": 1773.82, "5/1": 1755.32, "5/8": 1650.0, "5/15": 1815.82, "5/22": 1650.0, "5/29": 1650.0, "6/5": 1716.66, "6/12": 1750.0, "6/18": 1650.0, "6/26": 1795.32, "7/2": 1650.0, "7/10": 1824.14, "7/17": 650.0, "7/24": 2150.0, "7/31": 2150.0, "8/7": 2150.0}, "rtotals": {}}, {"name": "CE East", "rows": [{"name": "Galvis, Harold A (50%)", "former": false, "amts": {"6/5": 627.15, "6/12": 627.15, "6/18": 627.15, "6/26": 627.15, "7/2": 627.15, "7/10": 627.15, "7/17": 677.1, "7/24": 627.15, "7/31": 627.15, "8/7": 627.15}, "camts": {}, "net": {"6/5": 439.93, "6/12": 439.93, "6/18": 439.93, "6/26": 439.93, "7/2": 439.93, "7/10": 439.93, "7/17": 484.93, "7/24": 439.93, "7/31": 439.93, "8/7": 439.93}, "gross": {"6/5": 565.0, "6/12": 565.0, "6/18": 565.0, "6/26": 565.0, "7/2": 565.0, "7/10": 565.0, "7/17": 610.0, "7/24": 565.0, "7/31": 565.0, "8/7": 565.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 6321.45}, {"name": "Gelaw, Kidist B (50%)", "former": false, "amts": {"6/12": 627.15, "6/18": 627.15, "6/26": 627.15, "7/2": 627.15, "7/10": 627.15, "7/17": 627.15, "7/24": 627.15, "7/31": 627.15, "8/7": 627.15}, "camts": {}, "net": {"6/12": 474.94, "6/18": 474.94, "6/26": 474.94, "7/2": 474.94, "7/10": 474.94, "7/17": 474.94, "7/24": 474.94, "7/31": 474.94, "8/7": 474.94}, "gross": {"6/12": 565.0, "6/18": 565.0, "6/26": 565.0, "7/2": 565.0, "7/10": 565.0, "7/17": 565.0, "7/24": 565.0, "7/31": 565.0, "8/7": 565.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 5644.35}], "totals": {"6/5": 627.15, "6/12": 1254.3, "6/18": 1254.3, "6/26": 1254.3, "7/2": 1254.3, "7/10": 1254.3, "7/17": 1304.25, "7/24": 1254.3, "7/31": 1254.3, "8/7": 1254.3}, "ctotals": {}, "ltotals": {}, "rtotals": {}}, {"name": "J&A", "rows": [{"name": "Abrego, Valeria", "former": false, "amts": {"1/9": 888.0, "1/16": 888.0, "1/23": 888.0, "1/30": 888.0, "2/6": 888.0, "2/13": 888.0, "2/20": 888.0, "2/27": 888.0, "3/6": 888.0, "3/13": 888.0, "3/20": 1071.15, "3/27": 910.31, "4/3": 888.0, "4/10": 1026.75, "4/17": 888.0, "4/24": 888.0, "5/1": 888.0, "5/8": 1043.4, "5/15": 888.0, "5/22": 888.0, "5/29": 888.0, "6/5": 1110.0, "6/12": 999.0, "6/18": 888.0, "6/26": 888.0, "7/2": 888.0, "7/10": 888.0, "7/17": 888.0, "7/24": 888.0, "7/31": 888.0, "8/7": 921.3}, "camts": {}, "net": {"1/9": 684.72, "1/16": 684.72, "1/23": 684.72, "1/30": 684.72, "2/6": 684.72, "2/13": 684.72, "2/20": 684.72, "2/27": 684.72, "3/6": 684.72, "3/13": 684.72, "3/20": 817.3, "3/27": 700.87, "4/3": 684.72, "4/10": 809.72, "4/17": 684.72, "4/24": 684.72, "5/1": 684.72, "5/8": 824.72, "5/15": 684.72, "5/22": 684.72, "5/29": 684.72, "6/5": 884.72, "6/12": 784.72, "6/18": 684.72, "6/26": 684.72, "7/2": 684.72, "7/10": 684.72, "7/17": 684.72, "7/24": 684.72, "7/31": 684.72, "8/7": 708.82}, "gross": {"1/9": 800.0, "1/16": 800.0, "1/23": 800.0, "1/30": 800.0, "2/6": 800.0, "2/13": 800.0, "2/20": 800.0, "2/27": 800.0, "3/6": 800.0, "3/13": 800.0, "3/20": 965.0, "3/27": 820.1, "4/3": 800.0, "4/10": 925.0, "4/17": 800.0, "4/24": 800.0, "5/1": 800.0, "5/8": 940.0, "5/15": 800.0, "5/22": 800.0, "5/29": 800.0, "6/5": 1000.0, "6/12": 900.0, "6/18": 800.0, "6/26": 800.0, "7/2": 800.0, "7/10": 800.0, "7/17": 800.0, "7/24": 800.0, "7/31": 800.0, "8/7": 830.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 28393.91}, {"name": "Adamson, Christopher", "former": false, "amts": {"2/6": 2220.0, "2/13": 2220.0, "2/20": 2220.0, "2/27": 2220.0, "3/6": 2220.0, "3/13": 2220.0, "3/20": 2220.0, "3/27": 2220.0, "4/3": 2220.0, "4/10": 2220.0, "4/17": 2220.0, "4/24": 2220.0, "5/1": 2220.0, "5/8": 2220.0, "5/15": 2220.0, "5/22": 2220.0, "5/29": 2220.0, "6/5": 2220.0, "6/12": 2220.0, "6/18": 2220.0, "6/26": 2220.0, "7/2": 2220.0, "7/10": 2220.0, "7/17": 2220.0, "7/24": 2220.0, "7/31": 2220.0, "8/7": 2220.0}, "camts": {}, "net": {"2/6": 1004.41, "2/13": 1004.41, "2/20": 1004.41, "2/27": 1004.41, "3/6": 1004.41, "3/13": 1004.41, "3/20": 1004.41, "3/27": 1004.41, "4/3": 1004.41, "4/10": 1004.41, "4/17": 1004.41, "4/24": 1004.41, "5/1": 988.81, "5/8": 988.81, "5/15": 988.81, "5/22": 988.81, "5/29": 988.81, "6/5": 988.81, "6/12": 988.81, "6/18": 988.81, "6/26": 988.81, "7/2": 988.81, "7/10": 988.81, "7/17": 988.81, "7/24": 988.81, "7/31": 988.81, "8/7": 988.81}, "gross": {"2/6": 2000.0, "2/13": 2000.0, "2/20": 2000.0, "2/27": 2000.0, "3/6": 2000.0, "3/13": 2000.0, "3/20": 2000.0, "3/27": 2000.0, "4/3": 2000.0, "4/10": 2000.0, "4/17": 2000.0, "4/24": 2000.0, "5/1": 2000.0, "5/8": 2000.0, "5/15": 2000.0, "5/22": 2000.0, "5/29": 2000.0, "6/5": 2000.0, "6/12": 2000.0, "6/18": 2000.0, "6/26": 2000.0, "7/2": 2000.0, "7/10": 2000.0, "7/17": 2000.0, "7/24": 2000.0, "7/31": 2000.0, "8/7": 2000.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 59940.0}, {"name": "Dillon, Abigail", "former": false, "amts": {"1/16": 325.23, "1/23": 187.31, "1/30": 174.27, "2/6": 271.12, "2/13": 273.89, "2/20": 56.89, "2/27": 189.26, "3/6": 277.22, "3/13": 445.39, "3/20": 169.83, "4/3": 141.53, "4/10": 527.81, "4/17": 729.97, "4/24": 222.0}, "camts": {}, "net": {"1/16": 256.38, "1/23": 154.45, "1/30": 144.78, "2/6": 216.62, "2/13": 218.69, "2/20": 47.33, "2/27": 155.88, "3/6": 221.15, "3/13": 343.36, "3/20": 141.31, "4/3": 117.74, "4/10": 403.02, "4/17": 547.56, "4/24": 180.18}, "gross": {"1/16": 293.0, "1/23": 168.75, "1/30": 157.0, "2/6": 244.25, "2/13": 246.75, "2/20": 51.25, "2/27": 170.5, "3/6": 249.75, "3/13": 401.25, "3/20": 153.0, "4/3": 127.5, "4/10": 475.5, "4/17": 657.63, "4/24": 200.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 3991.72}, {"name": "Hoffman, Ben", "former": false, "amts": {"1/9": 1494.24, "1/16": 1494.24, "1/23": 1494.24, "1/30": 1494.24, "2/6": 1494.24, "2/13": 1494.24, "2/20": 1494.24, "2/27": 1494.24, "3/6": 1494.24, "3/13": 1494.24, "3/20": 1494.24, "3/27": 1494.24, "4/3": 1494.24, "4/10": 1494.24, "4/17": 1494.24, "4/24": 1538.64, "5/1": 1494.24, "5/8": 1494.24, "5/15": 1494.24, "5/22": 1494.24, "5/29": 1494.24, "6/5": 1494.24, "6/12": 1494.24, "6/18": 1494.24, "6/26": 1682.94, "7/2": 1494.24, "7/10": 1716.24, "7/17": 1494.24, "7/24": 1494.24, "7/31": 1494.24, "8/7": 1494.24}, "camts": {}, "net": {"1/9": 991.64, "1/16": 980.6, "1/23": 980.59, "1/30": 1074.83, "2/6": 1074.83, "2/13": 1074.83, "2/20": 1074.83, "2/27": 1116.83, "3/6": 1116.83, "3/13": 1116.83, "3/20": 1116.83, "3/27": 1116.83, "4/3": 1116.83, "4/10": 1116.82, "4/17": 1116.83, "4/24": 1156.83, "5/1": 1116.83, "5/8": 1116.83, "5/15": 1116.82, "5/22": 1116.83, "5/29": 1116.83, "6/5": 1116.83, "6/12": 1116.84, "6/18": 1116.82, "6/26": 1286.83, "7/2": 1116.83, "7/10": 1316.83, "7/17": 1116.83, "7/24": 1116.82, "7/31": 1116.83, "8/7": 1116.83}, "gross": {"1/9": 1346.16, "1/16": 1346.16, "1/23": 1346.16, "1/30": 1346.16, "2/6": 1346.16, "2/13": 1346.16, "2/20": 1346.16, "2/27": 1346.16, "3/6": 1346.16, "3/13": 1346.16, "3/20": 1346.16, "3/27": 1346.16, "4/3": 1346.16, "4/10": 1346.16, "4/17": 1346.16, "4/24": 1386.16, "5/1": 1346.16, "5/8": 1346.16, "5/15": 1346.16, "5/22": 1346.16, "5/29": 1346.16, "6/5": 1346.16, "6/12": 1346.16, "6/18": 1346.16, "6/26": 1516.16, "7/2": 1346.16, "7/10": 1546.16, "7/17": 1346.16, "7/24": 1346.16, "7/31": 1346.16, "8/7": 1346.16}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 46776.54}, {"name": "Law, Joshua", "former": false, "amts": {"7/2": 3225.85, "7/10": 2561.54, "7/17": 2561.54, "7/24": 2561.54, "7/31": 2561.54, "8/7": 2692.84}, "camts": {}, "net": {"7/2": 2621.17, "7/10": 2022.7, "7/17": 2022.69, "7/24": 2022.68, "7/31": 2022.7, "8/7": 2140.98}, "gross": {"7/2": 2906.17, "7/10": 2307.69, "7/17": 2307.69, "7/24": 2307.69, "7/31": 2307.69, "8/7": 2425.98}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 16164.85}, {"name": "Erika Valencio \u00b7 1099", "former": false, "amts": {}, "camts": {"7/10": 1730.0, "7/17": 1730.0, "7/24": 1730.0, "7/31": 1730.0, "8/7": 1730.0}, "net": {}, "gross": {}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 8650.0}, {"name": "Hilda Salman \u00b7 1099", "former": false, "amts": {}, "camts": {"1/9": 1730.0, "1/16": 1730.0, "1/23": 1730.0, "1/30": 1730.0, "2/6": 1730.0, "2/13": 1730.0, "2/20": 1730.0, "2/27": 1730.0, "3/6": 1730.0, "3/13": 1730.0, "3/20": 1730.0, "3/27": 1730.0, "4/3": 1730.0, "4/10": 1730.0, "4/17": 1730.0, "4/24": 1730.0, "5/1": 1730.0, "5/8": 1730.0, "5/15": 1730.0, "5/22": 1730.0, "5/29": 1730.0, "6/5": 1730.0, "6/12": 1730.0, "6/18": 1730.0, "6/26": 1730.0, "7/2": 1730.0, "7/10": 1730.0, "7/17": 1730.0, "7/24": 1730.0, "7/31": 1730.0, "8/7": 1730.0}, "net": {}, "gross": {}, "car": {}, "health": {"1/9": 118.82, "1/16": 118.82, "1/23": 118.82, "1/30": 118.82, "2/6": 118.82, "2/13": 118.82, "2/20": 118.82, "2/27": 118.82, "3/6": 118.82, "3/13": 118.82, "3/20": 118.82, "3/27": 118.82, "4/3": 118.82, "4/10": 118.82, "4/17": 118.82, "4/24": 118.82, "5/1": 118.82, "5/8": 118.82, "5/15": 118.82, "5/22": 118.82, "5/29": 118.82, "6/5": 118.82, "6/12": 118.82, "6/18": 118.82, "6/26": 118.82, "7/2": 118.82, "7/10": 118.82, "7/17": 118.82, "7/24": 118.82, "7/31": 118.82, "8/7": 118.82}, "commission": {}, "reimb": {}, "total": 57313.42}, {"name": "Kacy Richardson \u00b7 1099", "former": false, "amts": {}, "camts": {"7/17": 500.0, "7/24": 500.0, "7/31": 500.0, "8/7": 500.0}, "net": {}, "gross": {}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 2000.0}, {"name": "Logic Consultants \u00b7 1099", "former": false, "amts": {}, "camts": {"1/9": 500.0, "1/16": 500.0, "1/23": 500.0, "1/30": 500.0, "2/6": 500.0, "2/13": 500.0, "2/20": 500.0, "2/27": 500.0, "3/6": 500.0, "3/13": 500.0, "3/20": 500.0, "3/27": 500.0, "4/3": 500.0, "4/10": 500.0, "4/17": 500.0, "4/24": 500.0, "5/1": 500.0, "5/8": 500.0, "5/15": 500.0, "5/22": 500.0, "5/29": 500.0, "6/5": 500.0, "6/12": 500.0, "6/18": 500.0, "6/26": 500.0, "7/2": 500.0, "7/10": 500.0, "7/17": 500.0, "7/24": 500.0, "7/31": 500.0, "8/7": 500.0}, "net": {}, "gross": {}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 15500.0}, {"name": "Mellody Abrego \u00b7 1099", "former": false, "amts": {}, "camts": {"1/9": 2150.0, "1/16": 2150.0, "1/23": 2150.0, "1/30": 2150.0, "2/6": 2150.0, "2/13": 2150.0, "2/20": 4183.21, "2/27": 2150.0, "3/6": 2150.0, "3/13": 2150.0, "3/20": 2150.0, "3/27": 2150.0, "4/3": 2150.0, "4/10": 2150.0, "4/17": 2150.0, "4/24": 2150.0, "5/1": 2150.0, "5/8": 2150.0, "5/15": 1000.0, "5/22": 2550.0, "5/29": 2550.0, "6/5": 2550.0, "6/12": 2550.0, "6/18": 2550.0, "6/26": 2250.0, "7/2": 2250.0, "7/10": 2250.0, "7/17": 3130.86, "7/24": 2250.0, "7/31": 2250.0, "8/7": 2250.0}, "net": {}, "gross": {}, "car": {"1/9": 334.86, "2/6": 334.86, "3/6": 334.86, "4/10": 334.86, "5/8": 334.86, "6/5": 684.86, "7/2": 334.86, "8/7": 334.86}, "health": {"1/9": 368.34, "1/16": 368.34, "1/23": 368.34, "1/30": 368.34, "2/6": 368.34, "2/13": 368.34, "2/20": 368.34, "2/27": 368.34, "3/6": 368.34, "3/13": 368.34, "3/20": 368.34, "3/27": 368.34, "4/3": 368.34, "4/10": 368.34, "4/17": 368.34, "4/24": 368.34, "5/1": 368.34, "5/8": 368.34, "5/15": 368.34, "5/22": 368.34, "5/29": 368.34, "6/5": 368.34, "6/12": 368.34, "6/18": 368.34, "6/26": 368.34, "7/2": 368.34, "7/10": 368.34, "7/17": 368.34, "7/24": 368.34, "7/31": 368.34, "8/7": 368.34}, "commission": {"1/9": 320.83, "1/16": 320.83, "1/23": 320.83, "1/30": 320.83, "2/6": 320.83, "2/13": 320.83, "2/20": 320.83, "2/27": 320.83, "3/6": 320.83, "3/13": 320.83, "3/20": 320.83, "3/27": 190.12, "4/3": 190.12, "4/10": 190.12, "4/17": 190.12, "4/24": 190.12, "5/1": 190.12, "5/8": 190.12, "5/15": 320.83, "5/22": 190.12, "5/29": 190.12, "6/5": 190.12, "6/12": 190.12, "6/18": 190.12, "6/26": 1283.3, "7/2": 1283.3, "7/10": 1283.3, "7/17": 1283.31}, "reimb": {"4/24": 91.64, "5/1": 247.97, "5/15": 194.43}, "total": 96826.1}, {"name": "Adamson, Debra", "former": true, "amts": {"1/9": 1387.5, "1/16": 1387.5, "1/23": 1387.5, "1/30": 1387.5, "2/6": 1387.5, "2/13": 1387.5, "2/20": 1387.5}, "camts": {"2/27": 1184.97, "3/6": 1184.97, "3/13": 1184.97, "6/26": 1750.0, "7/2": 1750.0, "7/10": 1750.0, "7/17": 1750.0, "7/24": 1750.0, "7/31": 1750.0, "8/7": 1750.0}, "net": {"1/9": 1012.04, "1/16": 1012.04, "1/23": 1025.64, "1/30": 1025.64, "2/6": 1016.03, "2/13": 1016.03, "2/20": 1016.03}, "gross": {"1/9": 1250.0, "1/16": 1250.0, "1/23": 1250.0, "1/30": 1250.0, "2/6": 1250.0, "2/13": 1250.0, "2/20": 1250.0}, "car": {}, "health": {"1/9": 53.79, "1/16": 53.79, "1/23": 53.79, "1/30": 53.79, "2/6": 53.79, "2/13": 53.79, "2/20": 53.79, "2/27": 53.79, "3/6": 53.79, "3/13": 53.79, "3/20": 53.79, "3/27": 53.79, "4/3": 53.79, "4/10": 53.79, "4/17": 53.79, "4/24": 53.79, "5/1": 53.79, "5/8": 53.79, "5/15": 53.79, "5/22": 53.79, "5/29": 53.79, "6/5": 53.79, "6/12": 53.79, "6/18": 53.79, "6/26": 53.79, "7/2": 53.79, "7/10": 53.79, "7/17": 53.79, "7/24": 53.79, "7/31": 53.79, "8/7": 53.79}, "commission": {}, "reimb": {}, "total": 27184.9}, {"name": "Delgado, Elizabeth G", "former": true, "amts": {"1/9": 999.0, "1/16": 841.52, "1/23": 1338.36, "1/30": 1262.77, "2/6": 1163.24, "2/13": 2033.25, "2/20": 1842.49}, "camts": {"2/27": 1045.53, "3/6": 2056.84, "3/13": 1155.23, "3/20": 1098.16, "6/26": 900.0, "7/2": 900.0, "7/10": 900.0, "7/17": 2661.71, "7/24": 900.0, "7/31": 900.0, "8/7": 900.0}, "net": {"1/9": 774.69, "1/16": 660.7, "1/23": 1034.57, "1/30": 1012.32, "2/6": 922.65, "2/13": 1558.82, "2/20": 1386.96}, "gross": {"1/9": 900.0, "1/16": 758.13, "1/23": 1205.73, "1/30": 1137.63, "2/6": 1047.96, "2/13": 1831.76, "2/20": 1659.9}, "car": {}, "health": {}, "commission": {"2/27": 449.7, "3/6": 449.7, "3/13": 449.7, "3/20": 449.7, "6/26": 899.4, "7/2": 899.4, "7/10": 899.4, "7/17": 899.42}, "reimb": {"7/17": 50.32, "7/24": 253.25, "8/7": 348.58}, "total": 28294.52}, {"name": "Fissehaye, Biniyam G", "former": true, "amts": {"2/6": 1528.55, "2/13": 1498.5, "2/20": 1498.5, "2/27": 1498.5, "3/6": 1498.5, "3/13": 1498.5, "3/20": 1498.5, "3/27": 1498.5, "4/3": 1498.5, "4/10": 1498.5, "4/17": 1498.5, "4/24": 1498.5, "5/1": 1665.0, "5/8": 1498.5}, "camts": {"6/26": 1850.0, "7/2": 1850.0, "7/10": 1850.0, "7/17": 1850.0, "7/24": 1850.0, "7/31": 1850.0, "8/7": 1850.0}, "net": {"2/6": 1146.6, "2/13": 1119.54, "2/20": 1119.53, "2/27": 1119.54, "3/6": 1119.53, "3/13": 1119.54, "3/20": 1119.53, "3/27": 1119.54, "4/3": 1119.53, "4/10": 1119.54, "4/17": 1119.53, "4/24": 1119.54, "5/1": 1269.53, "5/8": 1119.54}, "gross": {"2/6": 1377.07, "2/13": 1350.0, "2/20": 1350.0, "2/27": 1350.0, "3/6": 1350.0, "3/13": 1350.0, "3/20": 1350.0, "3/27": 1350.0, "4/3": 1350.0, "4/10": 1350.0, "4/17": 1350.0, "4/24": 1350.0, "5/1": 1500.0, "5/8": 1350.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 34125.55}, {"name": "Hall, Kirsten", "former": true, "amts": {"1/9": 832.5, "1/16": 832.5, "1/23": 832.5}, "camts": {}, "net": {"1/9": 468.0, "1/16": 426.99, "1/23": 426.98}, "gross": {"1/9": 750.0, "1/16": 750.0, "1/23": 750.0}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 2497.5}, {"name": "Parnell, Branden A", "former": true, "amts": {"1/9": 1280.76, "1/16": 1280.76, "1/23": 1280.76, "1/30": 2561.52}, "camts": {}, "net": {"1/9": 1065.57, "1/16": 1065.57, "1/23": 1065.58, "1/30": 2131.14}, "gross": {"1/9": 1153.84, "1/16": 1153.84, "1/23": 1153.84, "1/30": 2307.68}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 6403.8}, {"name": "Sanchez, Ayelen R", "former": true, "amts": {"1/9": 471.75, "1/16": 493.95, "1/23": 291.38, "2/6": 751.2}, "camts": {}, "net": {"1/9": 380.95, "1/16": 397.41, "1/23": 242.42, "2/6": 593.41}, "gross": {"1/9": 425.0, "1/16": 445.0, "1/23": 262.5, "2/6": 676.76}, "car": {}, "health": {}, "commission": {}, "reimb": {}, "total": 2008.28}, {"name": "Simpson, Christopher", "former": true, "amts": {"1/9": 2120.99, "1/16": 2120.99, "1/23": 999.0, "1/30": 999.0, "2/6": 1374.66, "2/13": 1374.66, "2/20": 999.0}, "camts": {"2/27": 900.0, "3/6": 1415.79, "3/13": 1415.79, "3/20": 900.0, "6/26": 834.97, "7/2": 834.97, "7/10": 834.97, "7/17": 1340.34, "7/24": 834.97, "7/31": 1104.97, "8/7": 1127.47}, "net": {"1/9": 1619.31, "1/16": 1619.3, "1/23": 726.28, "1/30": 726.26, "2/6": 1025.26, "2/13": 1025.27, "2/20": 726.26}, "gross": {"1/9": 1910.8, "1/16": 1910.8, "1/23": 900.0, "1/30": 900.0, "2/6": 1238.43, "2/13": 1238.43, "2/20": 900.0}, "car": {}, "health": {"1/9": 53.79, "1/16": 53.79, "1/23": 53.79, "1/30": 53.79, "2/6": 53.79, "2/13": 53.79, "2/20": 53.79, "2/27": 53.79, "3/6": 53.79, "3/13": 53.79, "3/20": 53.79, "3/27": 53.79, "4/3": 53.79, "4/10": 53.79, "4/17": 53.79, "4/24": 53.79, "5/1": 53.79, "5/8": 53.79, "5/15": 53.79, "5/22": 53.79, "5/29": 53.79, "6/5": 53.79, "6/12": 53.79, "6/18": 53.79, "6/26": 53.79, "7/2": 53.79, "7/10": 53.79, "7/17": 53.79, "7/24": 53.79, "7/31": 53.79, "8/7": 53.79}, "commission": {"2/27": 318.9, "3/6": 318.9, "3/13": 318.9, "3/20": 318.9, "6/26": 637.8, "7/2": 637.8, "7/10": 637.8, "7/17": 637.8}, "reimb": {}, "total": 27026.83}], "totals": {"1/9": 9474.74, "1/16": 9664.69, "1/23": 8699.05, "1/30": 8767.3, "2/6": 11078.51, "2/13": 11170.04, "2/20": 10386.62, "2/27": 6290.0, "3/6": 6377.96, "3/13": 6546.13, "3/20": 6453.72, "3/27": 6123.05, "4/3": 6242.27, "4/10": 6767.3, "4/17": 6830.71, "4/24": 6367.14, "5/1": 6267.24, "5/8": 6256.14, "5/15": 4602.24, "5/22": 4602.24, "5/29": 4602.24, "6/5": 4824.24, "6/12": 4713.24, "6/18": 4602.24, "6/26": 4790.94, "7/2": 7828.09, "7/10": 7385.78, "7/17": 7163.78, "7/24": 7163.78, "7/31": 7163.78, "8/7": 7328.38}, "ctotals": {"1/9": 4380.0, "1/16": 4380.0, "1/23": 4380.0, "1/30": 4380.0, "2/6": 4380.0, "2/13": 4380.0, "2/20": 6413.21, "2/27": 7510.5, "3/6": 9037.6, "3/13": 8135.99, "3/20": 6378.16, "3/27": 4380.0, "4/3": 4380.0, "4/10": 4380.0, "4/17": 4380.0, "4/24": 4380.0, "5/1": 4380.0, "5/8": 4380.0, "5/15": 3230.0, "5/22": 4780.0, "5/29": 4780.0, "6/5": 4780.0, "6/12": 4780.0, "6/18": 4780.0, "6/26": 9814.97, "7/2": 9814.97, "7/10": 11544.97, "7/17": 15192.91, "7/24": 12044.97, "7/31": 12314.97, "8/7": 12337.47}, "ltotals": {"1/9": 5309.6, "1/16": 4974.74, "1/23": 4974.74, "1/30": 4974.74, "2/6": 5309.6, "2/13": 4974.74, "2/20": 7007.95, "2/27": 8105.24, "3/6": 9967.2, "3/13": 8730.73, "3/20": 6972.9, "3/27": 4974.74, "4/3": 4974.74, "4/10": 5309.6, "4/17": 4974.74, "4/24": 5066.38, "5/1": 5222.71, "5/8": 5309.6, "5/15": 4019.17, "5/22": 5374.74, "5/29": 5374.74, "6/5": 6059.6, "6/12": 5374.74, "6/18": 5374.74, "6/26": 10409.71, "7/2": 10744.57, "7/10": 12139.71, "7/17": 15837.97, "7/24": 12892.96, "7/31": 12909.71, "8/7": 13615.65}, "rtotals": {"4/24": 91.64, "5/1": 247.97, "5/15": 194.43, "7/17": 50.32, "7/24": 253.25, "8/7": 348.58}}]};
...
// Agents can be paid EITHER as 1099 draws (Kevin) or on W-2 payroll (Ethan).
// Either way they stay OUT of OFFICE_W2/CONTRACTORS and out of the Office Staff
...
const AGENTS = [
  { name:"Kevin Deveraux", dba:"Nixon Graye Associates", weekly:500, payments:13, weeklyTotal:6500, total:6500, note:"$500/wk · Agent · booked as a QB Contractor Payment · started May 11 2026 · $6,500 thru Aug 9 (rate confirmed unchanged by Ben)" },
  { name:"Ethan Smith", dba:"", weekly:1538.46, payments:2, weeklyTotal:3076.92, total:3421.52, note:"$1,538.46/wk gross ($80K/yr) · Agent on J&A W-2 payroll (not 1099) · first check Jul 31 2026, second Aug 7 · total = loaded cost (gross + $172.30/wk employer taxes)" },
];
...
const ATL_WEEKLY_LOG = [
  ...
  },
  {
    ...
    weekEnd: "2026-08-02",
    drivers: ["Baker Anthony", "Dawson Brian", "Pacitti Michael R", "Johnson Christopher M", "Logan LaDyle", "Phillips Anthony P", "Tucker Robert", "Wainwright Michael W"],
    driverPay: 17211.17,       // ATL_LABOR delta 167,927.70 - 150,716.53 (pay week ending Jul 31)
    driverHours: 548.75,       // ATL_HRS delta 4,827.29 - 4,278.54
    fuelAmt: 15804.08,         // exact Mon-Sun week, summed from EFS transaction dates for the 9 ATL cards
    fuelGallons: 2816.31,      // $5.612/gal
    contractors: [
      { name: "ENM Trucking LLC", entity: "ENM Trucking LLC (Biniyam Fissehaye 1099)", total: 1850 },
    ],
    contractorPay: 1850,
    note: "Week of Jul 27 - Aug 2. Roster unchanged at 8 active (Ben confirmed); Griffin still terminated and his card 07454 logged ZERO transactions this week, corroborating it. ATL trucks unchanged (7). Agents Kevin $500 + Ethan Smith (W-2, first check 7/31) are a separate bucket, NOT in the ATL total.",
  },
  {
    weekStart: "2026-08-03",
    weekEnd: "2026-08-09",
    drivers: ["Baker Anthony", "Dawson Brian", "Pacitti Michael R", "Johnson Christopher M", "Logan LaDyle", "Phillips Anthony P", "Tucker Robert", "Wainwright Michael W"],
    driverPay: 16749.58,       // exact: ATL_LABOR delta 184,677.28 - 167,927.70 (pay week ending Aug 7)
    driverHours: 515.73,       // exact: ATL_HRS delta 5,343.02 - 4,827.29
    fuelAmt: 14651.63,         // exact Mon-Sun: the two EFS reports end 2026-08-02 and 2026-08-09, so the YTD delta IS the week
    fuelGallons: 2748.59,      // $5.331/gal
    contractors: [
      { name: "ENM Trucking LLC", entity: "ENM Trucking LLC (Biniyam Fissehaye 1099)", total: 1850 },
    ],
    contractorPay: 1850,
    note: "Week of Aug 3-9. Roster unchanged at 8 active (Ben confirmed Aug 10); Griffin still terminated and his card 07454 is still frozen at $477.56 YTD — zero transactions again this week. ATL trucks unchanged (7). Agents Kevin $500 + Ethan Smith (W-2, 2nd check 8/7) are a separate bucket, NOT in the ATL total. ⚠ ATL_MILES is stale (thru Aug 1) — no Samsara export in this drop, so the ATL CPM tab's denominator lags this week's labor+fuel.",
  },
];
...
const ATL_BILLING = {
  asOf: "Aug 7, 2026",
  loads: 195,
  revenue: 558488.39,      // sum of Invoice Amount ("ATLANTA 2026 - ALL LOADS THRU 8.7", subtotal rows excluded). Driver-less format, so per-driver breakdown below is EMPTY until the sheet restores its Driver column
  carrierPay: 141620.62,   // sum of Carrier Amount = EXTERNAL carrier pay only. UNCHANGED from the 7.31 sheet: all 11 new loads have a blank Carrier Amount because SF hauled them itself (SF IS the carrier) — full income, no external carrier cost (SF's cost is in LABOR/FUEL fleet buckets). Blank ≠ pending.
  grossProfit: 416867.77,  // revenue − external carrier pay. SF-self-haul loads legitimately have no carrier deduction.
  grossMargin: 74.6,       // % — real brokerage margin (high because most loads ran on SF's own trucks, not outside carriers). Rose 72.8 → 74.6 only because the 11 new loads carried zero external carrier cost.
  // ⚠ The sheet's OWN subtotal rows have been unreliable (the 7.31 export's
  // revenue SUM stopped short by $36,800 and its carrier SUM by $10,075, and a
  // $616,134.01 row was revenue+carrier added together). Figures above are always
  // computed from the load rows by parse_atl_billing.py, NOT the sheet totals.
  ...
  return (
    <div>
      ...
      <div className="card" style={{ marginBottom:14, borderLeft:"3px solid var(--or)" }}>
        ...
        <div style={{ fontSize:10, color:"var(--mu)", marginTop:8 }}>
          Loaded cost (gross + employer taxes + 401k) · contractors all-in: cash + car allowance + company health + reimbursements
        </div>
      </div>
      )}

        ...
        return (
          <div className="card" style={{ marginBottom:14, padding:0 }}>
            ...
            <div style={{ padding:"8px 14px", fontSize:11, color:"var(--mu)" }}>
              Grand total (W-2 loaded + 1099 actual payments, all weeks): <b style={{ color:"var(--tx)" }}>{fc(grand)}</b> · contractor cells = actual dated payments (QB + Chase, incl car/reimbursements) · Maria Con = est. (not in either file) · agent excluded · CE East = only Harold/Kidi split halves
            </div>
          </div>
        );
      })()}
